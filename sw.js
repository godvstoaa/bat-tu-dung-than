...
const CACHE = 'bazi-mren2ym4'; // [loop 236] auto-versioned by Vite plugin (swAutoVersion) — replaced at build time with timestamp. This default only used if plugin doesn't run.
