...
const CACHE = 'bazi-mrcxxq7i'; // [loop 236] auto-versioned by Vite plugin (swAutoVersion) — replaced at build time with timestamp. This default only used if plugin doesn't run.
