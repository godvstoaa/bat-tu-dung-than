...
const DREAM_DICT = [
  ...
  // [loop 1284] thêm 8 mục phổ biến thiếu (周公解梦, đối chiếu 知乎/2345/百度)
  { kw: '追赶', vi: 'Đuổi theo/Bị đuổi', aliases: ['追赶', 'duoi theo', 'đuổi theo', 'duoi', 'bi duoi', 'bị đuổi', 'truy sát'],
    tone: 'hung',
    meaning: 'Mộng bị đuổi theo — phản ánh nỗi sợ hãi, áp lực, trốn tránh trách nhiệm/vấn đề. Bị động vật đuổi = kìm nén bản năng; bị người đuổi = sợ người xung quanh hoặc trốn trách nhiệm.',
    advice: 'Đối mặt vấn đề đang trốn tránh; giảm căng thẳng.' },
  { kw: '丢失', vi: 'Mất đồ', aliases: ['丢失', 'mat do', 'mất đồ', 'mat vi', 'mất ví', 'thất lạc', 'mat tien', 'mất tiền'],
    tone: 'mid',
    meaning: 'Mộng mất đồ — thiếu an toàn, sợ mất thứ yêu thích. Cổ: mất đồ đôi khi ngược = được quà/tài; mất tiền = có tài vận.',
    advice: 'Tận dụng cơ hội tài chính đang đến; đừng lo âu quá.' },
  { kw: '战争', vi: 'Chiến tranh', aliases: ['战争', 'chien tranh', 'chiến tranh', 'chien dau', 'đánh nhau', 'dien cuong'],
    tone: 'hung',
    meaning: 'Mộng chiến tranh = sắp chịu khổ/nháo động; trong lòng xung đột gay gắt. Chiến trường xa = ảnh hưởng ít nhưng người thân khổ.',
    advice: 'Giữ bình tĩnh; tránh xung đột với người thân.' },
  { kw: '河', vi: 'Sông', aliases: ['河', 'song', 'sông', 'ha', 'giang', 'kênh', 'suối', 'khe'],
    tone: 'mid',
    meaning: 'Mộng sông = quá độ giai đoạn sống; qua sông = vượt thử thách. Sông yên = hạnh phúc/phú quý; nước trong = hanh thông; sông cạn = thiệt hại.',
    advice: 'Qua sông = tiến triển; nhìn nước trong/tối định cát hung.' },
  { kw: '伞', vi: 'Ô/Dù', aliases: ['伞', 'o', 'ô', 'du', 'dù', '雨伞', 'cay o', 'che ô'],
    tone: 'cat',
    meaning: 'Mộng ô/dù = cát, bảo vệ, việc tốt sắp đến. Đàn ông = gia đình yên ấm; phụ nữ = việc thuận; chưa kết hôn = tìm được ý中人. («Ô» ≈ «tản» — cũng có dị bản phân ly).',
    advice: 'Đón tin vui; chú ý sức khoẻ gia đình.' },
  { kw: '笔', vi: 'Bút', aliases: ['笔', 'but', 'bút', 'mao but', 'bút lông', 'gang but', 'bút máy', 'but chi', 'bút chì'],
    tone: 'cat',
    meaning: 'Mộng bút = văn tài, học nghiệp有成, phát tài. Bút lông = văn tư như suối, danh扬; bút máy = thắng được trọng dụng. Người thất nghiệp mộng = sắp có việc.',
    advice: 'Tận dụng tài năng/văn chương; thi cử thuận lợi.' },
  { kw: '钟表', vi: 'Đồng hồ', aliases: ['钟表', 'dong ho', 'đồng hồ', 'watch', '手表', 'thoi gian', 'xem giờ', 'thoi gian'],
    tone: 'mid',
    meaning: 'Mộng đồng hồ = cảm thấy thời gian quý/qua nhanh. Đeo = có trở ngại; đập vỡ = phiền não; hỏng = thăng chức.',
    advice: 'Quý trọng thời gian; hành động kịp thời.' },
  { kw: '帽子', vi: 'Mũ', aliases: ['帽子', 'mu', 'mũ', 'noi bat', 'nón', 'non', 'đội mũ'],
    tone: 'mid',
    meaning: 'Mộng mũ = địa vị, thân phận, hình tượng. Đội mũ = quan tâm đến danh vọng; mất mũ = khó phát triển lớn trừ kiên cường. «Bạch cái phúc thân» = cát.',
    advice: 'Chú ý hình tượng/địa vị xã hội; giữ khiêm tốn.' },
  // [loop 1285] thêm 8 mục phổ biến thiếu (周公解梦)
  { kw: '桥', vi: 'Cầu', aliases: ['桥', 'cau', 'cầu', 'chiec cau', 'cây cầu', 'bắc cầu'],
    tone: 'cat',
    meaning: 'Mộng cầu = kết nối, quá độ, vượt khó. Qua cầu = hanh thông, thành công; cầu gãy = trở ngại; xây cầu = phúc đức.',
    advice: 'Qua cầu = cơ hội mới; kiên nhẫn vượt khó.' },
  { kw: '梯', vi: 'Thang', aliases: ['梯', 'thang', 'thang may', 'thang máy', 'leo thang', 'len thang', 'leo lên'],
    tone: 'cat',
    meaning: 'Mộng leo thang = thăng tiến, địa vị nâng cao, mục tiêu đạt. Leo lên = cát; rơi xuống = trở ngại tạm thời.',
    advice: 'Tận dụng đà thăng tiến; cẩn thận rớt.' },
  { kw: '酒', vi: 'Rượu/Bia', aliases: ['酒', 'ruou', 'rượu', 'bia', 'wine', 'beer', 'uống', 'uong'],
    tone: 'mid',
    meaning: 'Mộng uống rượu = có việc buồn/cãi vã nếu quá chén; rượu ngon đãi khách = cát, tài lộc. Say = mất kiểm soát.',
    advice: 'Kiềm chế; đón tin vui nếu mộng rượu đãi khách.' },
  { kw: '茶', vi: 'Trà', aliases: ['茶', 'tra', 'trà', 'uống trà', 'chen tra', 'ấm trà'],
    tone: 'cat',
    meaning: 'Mộng trà = thanh tịnh, bình an, khách đến. Pha trà mời khách = nhân duyên tốt.',
    advice: 'Giữ tâm bình an; đón khách/nhân duyên.' },
  { kw: '肉', vi: 'Thịt', aliases: ['肉', 'thit', 'thịt', 'an thit', 'ăn thịt', 'thit lon', 'thịt lợn'],
    tone: 'mid',
    meaning: 'Mộng thịt = tài lộc/dục vọng. Ăn thịt = phú quý nếu ngon; thịt ôi thiu = bệnh hoạn/tai hoạ.',
    advice: 'Cẩn thận sức khoẻ; đón tài nếu thịt tươi.' },
  { kw: '菜', vi: 'Rau', aliases: ['菜', 'rau', 'rau cu', 'rau cải', 'xanh', 'rau xanh'],
    tone: 'cat',
    meaning: 'Mộng rau xanh = bình an, sức khoẻ, sống giản dị. Trồng rau = phúc đức, kiên nhẫn.',
    advice: 'Sống giản dị; chú ý sức khoẻ.' },
  { kw: '盐', vi: 'Muối', aliases: ['盐', 'muoi', 'muối', 'muoi bien', 'muối'],
    tone: 'mid',
    meaning: 'Mộng muối = gia vị cuộc sống, hao tài nếu đổ; nhận muối = có quý nhân.',
    advice: 'Cẩn thận hao tài; đón quý nhân.' },
  { kw: '烛', vi: 'Nến/Đèn cầy', aliases: ['烛', 'nen', 'nến', 'đèn cầy', 'den cày', 'nến', 'thắp nến', 'thap nen'],
    tone: 'cat',
    meaning: 'Mộng nến = sáng suốt, hy vọng, thi cử tốt. Thắp nến = khai sáng, phúc đức; tắt nến = mất hướng.',
    advice: 'Đón ánh sáng cơ hội; học tập/thi cử thuận.' },
  // [loop 1286] thêm 7 mục phổ biến thiếu
  { kw: '碗', vi: 'Bát', aliases: ['碗', 'bat', 'bát', 'chen', 'chén', 'tách', 'tac', 'ly'],
    tone: 'mid',
    meaning: 'Mộng bát/chén = sinh kế, công việc. Bát đầy = phú quý; bát vỡ = mất việc/cãi vã; bát trống = nghèo khó tạm thời.',
    advice: 'Đảm bảo công ăn việc làm; cẩn thận cãi vã.' },
  { kw: '筷', vi: 'Đũa', aliases: ['筷', 'dua', 'đũa', 'đôi đũa', 'doi dua'],
    tone: 'cat',
    meaning: 'Mộng đũa = thêm người ăn (có khách/thêm thành viên); gãy đũa = xung đột gia đình.',
    advice: 'Đón khách/thêm người; tránh cãi vã.' },
  { kw: '灯', vi: 'Đèn', aliases: ['灯', 'den', 'đèn', 'điện', 'dien', 'bóng đèn', 'bong den', 'thắp đèn', 'thap den'],
    tone: 'cat',
    meaning: 'Mộng đèn sáng = hy vọng, minh mẫn, tài lộc; đèn tắt/vỡ = trở ngại, mất phương hướng.',
    advice: 'Đón sáng/hy vọng; cẩn thận trở ngại nếu tối.' },
  { kw: '玉', vi: 'Ngọc', aliases: ['玉', 'ngoc', 'ngọc', 'kim cuong', 'kim cương', 'đá quý', 'da quy'],
    tone: 'cat',
    meaning: 'Mộng ngọc/đá quý = phú quý, đạo đức, thanh cao. Nhặt được ngọc = phát tài; mất ngọc = hao tài/tin buồn.',
    advice: 'Đón tài lộc; giữ phẩm hạnh.' },
  { kw: '乳', vi: 'Sữa', aliases: ['乳', 'sua', 'sữa', 'milk', 'bu sữa', 'sữa mẹ'],
    tone: 'cat',
    meaning: 'Mộng sữa = dinh dưỡng, sinh lực, mẫu tính. Uống sữa = khỏe mạnh; sữa mẹ = tình mẫu tử.',
    advice: 'Bổ dưỡng; giữ tình cảm gia đình.' },
  { kw: '蛋', vi: 'Trứng', aliases: ['蛋', 'trung', 'trứng', 'egg', 'trung ga', 'trứng gà'],
    tone: 'cat',
    meaning: 'Mộng trứng = sinh sản, khởi đầu mới, tài sản. Trứng nở = sinh lực; trứng vỡ = thất bại tạm thời.',
    advice: 'Đón khởi đầu mới; kiên nhẫn ấp ủ.' },
  { kw: '蜜', vi: 'Mật ong', aliases: ['蜜', 'mat ong', 'mật ong', 'ngọt', 'ngot', 'đường mật'],
    tone: 'cat',
