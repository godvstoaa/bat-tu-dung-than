...
const GUIGUZI_NAYIN = {
  ...
  '砂中金': { vi: 'Kim Trong Cát', tone: 'bình', verse: '砂里淘金费功夫', fortune: 'Cần kiên nhẫn «sa li đào kim» — tài năng rải rác, cần thu thập. Vất vả sớm, thu hoạch muộn.', career: 'khai khoáng, đầu tư giá trị, sưu tầm' },
  ...
  '金薄金': { vi: 'Kim Lá Mỏng', tone: 'hung', verse: '金箔华丽易破损', fortune: 'Đẹp nhưng mỏng — như lá vàng. Bề ngoài hào nhoáng nhưng dễ tổn thương. Cần nội dung thực.', career: 'trang trí, quảng cáo, hình ảnh, thời trang' },
  ...
  '砂中土': { vi: 'Đất Trong Cát', tone: 'hung', verse: '砂中土散难成形', fortune: 'Rời rạc, cần gom — như đất trong cát. Khó tập trung, cần kỷ luật. Nên tìm nền tảng vững.', career: 'xây dựng, quy hoạch, quản lý dự án' },
...
export function guiguziFortune(R) {
  ...
  return { yearJiaZi, nayin, ...info, toneVi, summary };
}
