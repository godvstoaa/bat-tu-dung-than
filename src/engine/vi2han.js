...
const NAME_VI = {
  ...
  hà: { han: '河', strokes: 8 }, hải: { han: '海', strokes: 11 }, phương: { han: '方', strokes: 4 },
  // Given names (nam)
  ...
  // Given names (nữ)
  chang: { han: '嫦娥', strokes: 0 }, dao: { han: '瑤', strokes: 15 }, dung: { han: '容', strokes: 10 },
  gam: { han: '澄', strokes: 15 }, hương: { han: '香', strokes: 9 }, hường: { han: '紅', strokes: 9 },
  kiều: { han: '嬌', strokes: 15 }, lan: { han: '蘭', strokes: 23 }, linh: { han: '玲', strokes: 10 },
 loan: { han: '鸞', strokes: 27 }, mai: { han: '梅', strokes: 11 }, my: { han: '眉', strokes: 9 },
  ...
  mi: { han: '眉', strokes: 9 }, nguyệt: { han: '月', strokes: 4 }, nga: { han: '娥', strokes: 10 },
  oanh: { han: '鶯', strokes: 21 }, phúc: { han: '福', strokes: 14 }, linh: { han: '鈴', strokes: 13 },
  tram: { han: '簪', strokes: 18 }, trang: { han: '莊', strokes: 13 }, vi: { han: '薇', strokes: 19 },
  ...
  trang: { han: '妝', strokes: 7 }, như: { han: '如', strokes: 6 }, tín: { han: '信', strokes: 9 },
