...
export function computeHehun(R1, R2) {
  ...
  try {
    ...
    const nayinWx = { '海中金':'金','炉中火':'火','大林木':'木','路旁土':'土','剑锋金':'金','山头火':'火','涧下水':'水','城头土':'土','白蜡金':'金','杨柳木':'木','泉中水':'水','屋上土':'土','霹雳火':'火','松柏木':'木','长流水':'水','沙中金':'金','沙中土':'土','山下火':'火','平地木':'木','壁上土':'土','金箔金':'金','覆灯火':'火','天河水':'水','大驿土':'土','钗钏金':'金','桑柘木':'木','大溪水':'水','天上火':'火','石榴木':'木','大海水':'水' }; // [loop 1198] xóa 砂中金 chết (ganZhiNayin chỉ trả 沙中金) → 30 chuẩn
