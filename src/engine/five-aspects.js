...
const FIVE_VIRTUES = {
  木: {
    ...
    balance: 'Nhân 需要 礼 (Hỏa) để bộc lộ + 智 (Thủy) để linh hoạt',
  },
  火: {
    ...
    balance: 'Lễ 需要 智 (Thủy) để tiết chế + 信 (Thổ) để bền vững',
  },
  土: {
    ...
    balance: 'Tín 需要 智 (Thủy) để linh hoạt + 仁 (Mộc) để từ bi',
  },
  金: {
    ...
    balance: 'Nghĩa 需要 礼 (Hỏa) để ấm áp + 仁 (Mộc) để từ bi',
  },
  水: {
    ...
    balance: 'Trí 需要 信 (Thổ) để vững + 义 (Kim) để chính trực',
  },
};
