...
const YEAR_WEIGHT = [
  ...
  1.5, 0.9, 1.5, 0.6, 0.8, 1.9, 1.2, 0.7, 0.9, 0.7,   // 甲戌..癸未 (10-19)
  0.5, 1.2, 0.6, 1.6, 1.5, 0.7, 0.9, 1.2, 1.0, 0.7,   // 甲申..癸巳 (20-29)
  1.5, 0.6, 0.5, 1.4, 1.4, 0.9, 0.7, 0.7, 0.9, 1.2,   // 甲午..癸卯 (30-39)
  0.8, 0.7, 1.3, 0.5, 0.8, 0.5, 0.9, 1.7, 0.5, 0.7,   // 甲辰..癸丑 (40-49)
  1.2, 0.8, 0.8, 0.6, 1.9, 0.6, 0.8, 0.8, 1.0, 0.6,   // 甲寅..癸亥 (50-59)
];
