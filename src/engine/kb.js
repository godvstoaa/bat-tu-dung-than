...
export const QIONGTONG_TIAOHOU = {
  ...
  '癸子月': 'Thủy mùa đông → "癸水冬月,丙火解冻" → Hỏa sưởi là ưu tiên số 1.','甲子月': 'Đông hàn cực, Giáp Mộc đông phục — cần Đinh Hỏa noãn gốc trước, Canh Kim đẽo thành khí, Bính Hỏa phụ. Ưu tiên: Đinh → Canh → Bính. — 甲木子月，丁火为尊，庚金次之',
  '甲丑月': 'Quý đông hàn thấp, thổ băng — Mộc cần Đinh Hỏa giải hàn trước, Canh Kim trác cụ, Bính Hỏa phụ noãn. Ưu tiên: Đinh → Canh → Bính. — 甲木丑月，丁火为先，庚金次之',
  '甲辰月': 'Quý xuân thấp thổ, mộc khí lão — cần Canh Kim phạt mộc thành tài, Đinh Hỏa ôn nhuận, Nhâm Thủy tưới. Ưu tiên: Canh → Đinh → Nhâm. — 甲木辰月，庚金为主，丁壬为佐',
  '甲未月': 'Quý hạ táo nhiệt, mộc bị thiêu — gấp Quý Thủy nhuận, Đinh Hỏa tiết tú vừa, Canh Kim phụ. Ưu tiên: Quý → Đinh → Canh. — 甲木未月，癸水为先，丁火次之',
  '甲酉月': 'Thu kim vượng khắc mộc — cần Canh Kim có chế (đẽo đúng cách), Đinh/Bính Hỏa luyện kim giữ mộc. Ưu tiên: Canh → Đinh → Bính. — 甲木酉月，庚丁并用，丙火佐之',
  '甲戌月': 'Quý thu táo thổ, kim khí suy — cần Canh Kim trác, Giáp Mộc tự vượng, Đinh Hỏa + Nhâm Thủy điều hòa. Ưu tiên: Canh → Giáp → Đinh. — 甲木戌月，庚甲为用，丁壬调候',
  '乙子月': 'Ất Mộc đông hàn — chỉ Bính Hỏa mới đủ dương noãn cho hoa nở; thiếu Bính thì mộc trầm. Ưu tiên tuyệt đối: Bính Hỏa. — 乙木子月，非丙不暖',
  '乙丑月': 'Quý đông hàn thấp — Ất Mộc hướng dương, Bính Hỏa sưởi là dụng thần độc tôn. Ưu tiên: Bính Hỏa. — 乙木丑月，丙火为尊',
  '乙卯月': 'Xuân phân mộc vượng — cần Bính Hỏa tiết tú nở hoa, Quý Thủy nhuận gốc. Ưu tiên: Bính → Quý. — 乙木卯月，丙癸两全',
  '乙辰月': 'Quý xuân thấp thổ — cần Quý Thủy thông thổ nhuận mộc, Bính Hỏa ôn, Mậu Thổ phụ. Ưu tiên: Quý → Bính → Mậu. — 乙木辰月，癸水为先，丙火佐之',
  '乙午月': 'Hạ cực nhiệt, hoa dễ tàn — gấp Quý Thủy tưới, Bính Hỏa giữ sắc (đủ không quá). Ưu tiên: Quý → Bính. — 乙木午月，先取癸水，丙火次之',
  '乙未月': 'Quý hạ táo thổ — Ất Mộc khô cần Quý Thủy nhuận trước, Bính Hỏa phụ. Ưu tiên: Quý → Bính. — 乙木未月，癸丙为用',
  '乙酉月': 'Thu kim vượng, mộc bị khắc — cần Quý Thủy hóa kim sinh mộc, Bính/Đinh Hỏa chế kim. Ưu tiên: Quý → Bính → Đinh. — 乙木酉月，癸水淘金，丙丁制杀',
  '乙戌月': 'Quý thu táo — cần Quý Thủy nhuận, Tân Kim nhẹ cắt tỉa (không nặng). Ưu tiên: Quý → Tân. — 乙木戌月，癸辛为用',
  '丙子月': 'Đông hàn, Bính Hỏa yếu — cần Giáp Mộc sinh hỏa (ấn), Nhâm Thủy đã tế vừa, Mậu Thổ ngăn thủy. Ưu tiên: Giáp → Nhâm → Mậu. — 丙火子月，甲木为根，壬戊调候',
  '丙丑月': 'Quý đông hàn thấp — cần Nhâm Thủy đã tế (hỏa không khô), Giáp Mộc sinh hỏa. Ưu tiên: Nhâm → Giáp. — 丙火丑月，壬甲并用',
  '丙卯月': 'Xuân mộc vượng sinh hỏa — hỏa dễ viêm, cần Nhâm Thủy chế, Kỷ Thổ tiết. Ưu tiên: Nhâm → Kỷ. — 丙火卯月，壬水为尊，己土泄秀',
  '丙辰月': 'Quý xuân thấp — cần Nhâm Thủy thanh, Giáp Mộc thông quan sinh hỏa. Ưu tiên: Nhâm → Giáp. — 丙火辰月，壬甲为用',
  '丙午月': 'Ngọ hỏa cực炎 — gấp Nhâm Thủy đã tế, Canh Kim sinh nhâm. Ưu tiên: Nhâm → Canh. — 丙火午月，壬庚为上，天和地润',
  '丙未月': 'Quý hạ táo nhiệt — cần Nhâm Thủy giáng ôn, Canh Kim sinh thủy. Ưu tiên: Nhâm → Canh. — 丙火未月，壬水制炎，庚金生水',
  '丙酉月': 'Thu kim tài vượng — cần Nhâm/Quý Thủy thanh kim, giữ hỏa không khô. Ưu tiên: Nhâm → Quý. — 丙火酉月，壬癸润局',
  '丙戌月': 'Quý thu táo thổ — cần Giáp Mộc sinh hỏa, Nhâm Thủy nhuận. Ưu tiên: Giáp → Nhâm. — 丙火戌月，甲壬为用',
  '丁丑月': 'Quý đông hàn — Đinh Hỏa cần Giáp Mộc (đích mẫu) sinh, Canh Kim dẫn hỏa. Ưu tiên: Giáp → Canh. — 丁火甲木，嫡母也；丑月甲庚并用',
  '丁卯月': 'Xuân mộc vượng — cần Canh Kim trác mộc (tránh mộc quá che hỏa), Giáp Mộc vừa. Ưu tiên: Canh → Giáp. — 丁火卯月，庚金劈甲，甲木生丁',
  '丁辰月': 'Quý xuân — cần Giáp Mộc sinh đinh, Canh Kim điều. Ưu tiên: Giáp → Canh. — 丁火辰月，甲庚为用',
  '丁巳月': 'Hạ sơ hỏa bộc — vẫn cần Giáp Mộc làm gốc, Canh Kim chế. Ưu tiên: Giáp → Canh. — 丁火巳月，甲木为根，庚金佐之',
  '丁未月': 'Quý hạ táo — cần Giáp Mộc, Nhâm Thủy đã tế, Canh Kim phụ. Ưu tiên: Giáp → Nhâm → Canh. — 丁火未月，甲壬并见为上',
  '丁申月': 'Thu sơ kim tiến — cần Giáp Mộc + Canh Kim, Bính Hỏa/ Mậu Thổ phụ. Ưu tiên: Giáp → Canh → Bính. — 丁火申月，甲庚丙戊',
  '丁戌月': 'Quý thu táo thổ — cần Giáp Mộc sinh, Canh Kim, Mậu Thổ. Ưu tiên: Giáp → Canh → Mậu. — 丁火戌月，甲庚为尊',
  '丁亥月': 'Đông sơ hàn — Đinh gặp hợi thủy, cần Giáp Mộc thông quan, Canh Kim. Ưu tiên: Giáp → Canh. — 丁火亥月，大忌水多，甲庚解救',
  '戊子月': 'Đông hàn thổ lạnh — cần Bính Hỏa noãn thổ, Giáp Mộc xới thổ. Ưu tiên: Bính → Giáp. — 戊土子月，丙甲为先',
  '戊丑月': 'Quý đông hàn thấp — thổ băng cần Bính Hỏa sưởi, Giáp Mộc thông. Ưu tiên: Bính → Giáp. — 戊土丑月，丙火暖土，甲木疏通',
  '戊卯月': 'Xuân mộc khắc thổ — cần Bính Hỏa sinh thổ + chế mộc, Giáp/Quý điều. Ưu tiên: Bính → Giáp → Quý. — 戊土卯月，丙火为尊，甲癸佐之',
  '戊辰月': 'Quý xuân thấp thổ — cần Giáp Mộc sơ thổ, Bính Hỏa, Quý Thủy vừa. Ưu tiên: Giáp → Bính → Quý. — 戊土辰月，甲丙癸并用',
  '戊午月': 'Hạ cực táo — thổ khô nứt, gấp Nhâm Thủy nhuận, Giáp Mộc + Bính Hỏa. Ưu tiên: Nhâm → Giáp → Bính. — 戊土夏月，先看壬癸',
  '戊未月': 'Quý hạ táo thổ — cần Quý Thủy tưới, Bính Hỏa, Giáp Mộc. Ưu tiên: Quý → Bính → Giáp. — 戊土未月，癸水润燥为先',
  '戊酉月': 'Thu kim thực thổ — cần Bính Hỏa sinh thổ, Quý Thủy nhuận. Ưu tiên: Bính → Quý. — 戊土酉月，丙癸为用',
  '戊戌月': 'Quý thu táo — cần Giáp Mộc sơ thổ, Bính Hỏa, Quý Thủy. Ưu tiên: Giáp → Bính → Quý. — 戊戌月，甲丙癸调候',
  '己丑月': 'Quý đông hàn thấp — Kỷ Thổ cần Bính Hỏa noãn, Giáp Mộc, Mậu Thổ trợ. Ưu tiên: Bính → Giáp → Mậu. — 己土冬月，丙火为先',
  '己卯月': 'Xuân mộc khắc thổ — cần Giáp Mộc vừa (thành cách), Quý Thủy, Bính Hỏa. Ưu tiên: Giáp → Quý → Bính. — 己土卯月，甲癸丙并用',
  '己辰月': 'Quý xuân thấp — cần Bính Hỏa táo thấp, Quý Thủy thông, Giáp Mộc. Ưu tiên: Bính → Quý → Giáp. — 己土辰月，丙癸为尊',
  '己巳月': 'Hạ sơ táo nhiệt — gấp Quý Thủy nhuận điền, Bính Hỏa phụ. Ưu tiên: Quý → Bính. — 己土巳月，先取癸水',
  '己未月': 'Quý hạ táo — cần Quý Thủy tưới ruộng, Bính Hỏa. Ưu tiên: Quý → Bính. — 己土未月，癸丙为用',
  '己申月': 'Thu sơ kim thực thổ — cần Bính Hỏa sinh thổ, Quý Thủy nhuận. Ưu tiên: Bính → Quý. — 己土申月，丙癸并用',
  '己戌月': 'Quý thu táo thổ — cần Giáp Mộc sơ, Bính Hỏa, Quý Thủy. Ưu tiên: Giáp → Bính → Quý. — 己土戌月，甲丙癸调候',
  '己亥月': 'Đông sơ hàn — cần Bính Hỏa noãn, Giáp Mộc, Mậu Thổ. Ưu tiên: Bính → Giáp → Mậu. — 己土亥月，丙甲为尊',
  '庚子月': 'Đông kim hàn thủy lãnh — gấp Đinh/Bính Hỏa luyện noãn, Giáp Mộc dẫn hỏa. Ưu tiên: Đinh → Bính → Giáp. — 金寒水冷，非火不暖；子月丁丙甲',
  '庚丑月': 'Quý đông hàn thấp — cần Bính Hỏa noãn kim trước, Đinh Hỏa luyện, Giáp Mộc. Ưu tiên: Bính → Đinh → Giáp. — 庚金丑月，丙丁暖炼，甲木引丁',
  '庚卯月': 'Xuân mộc vượng — cần Đinh Hỏa luyện kim, Giáp Mộc (tài), Canh/Bính phụ. Ưu tiên: Đinh → Giáp → Canh. — 庚金劈甲引丁',
  '庚辰月': 'Quý xuân — cần Giáp Mộc làm tài, Đinh Hỏa luyện, Nhâm/Quý Thủy thanh. Ưu tiên: Giáp → Đinh → Nhâm. — 庚金辰月，甲丁壬癸',
  '庚午月': 'Hạ cực hỏa khắc kim — gấp Nhâm/Quý Thủy chế hỏa cứu kim. Ưu tiên: Nhâm → Quý. — 庚金午月，壬癸为急',
  '庚未月': 'Quý hạ táo — cần Đinh Hỏa luyện (vừa), Giáp Mộc. Ưu tiên: Đinh → Giáp. — 庚金未月，丁甲为用',
  '庚酉月': 'Thu kim vượng (đế vượng) — cần Đinh Hỏa luyện thành khí, Giáp Mộc, Bính Hỏa phụ. Ưu tiên: Đinh → Giáp → Bính. — 庚金酉月，非丁不威，甲木为辅',
  '庚戌月': 'Quý thu — cần Giáp Mộc làm tài, Nhâm Thủy thanh kim. Ưu tiên: Giáp → Nhâm. — 庚金戌月，甲壬为用',
  '辛丑月': 'Quý đông hàn — Tân Kim cần Bính Hỏa noãn, Nhâm Thủy tẩy, Mậu/Kỷ Thổ. Ưu tiên: Bính → Nhâm → Mậu. — 辛金丑月，丙壬调候，戊己为根',
  '辛卯月': 'Xuân mộc vượng — cần Nhâm Thủy tẩy kim, Giáp Mộc làm tài. Ưu tiên: Nhâm → Giáp. — 辛金卯月，壬甲为用',
  '辛辰月': 'Quý xuân thấp — cần Nhâm Thủy thanh, Giáp Mộc. Ưu tiên: Nhâm → Giáp. — 辛金辰月，壬水淘洗，甲木成器',
  '辛午月': 'Hạ hỏa khắc kim — gấp Nhâm Thủy cứu, Kỷ Thổ sinh kim, Quý Thủy phụ. Ưu tiên: Nhâm → Kỷ → Quý. — 辛金午月，己壬两全',
  '辛未月': 'Quý hạ — cần Nhâm Thủy tẩy, Canh Kim, Giáp Mộc. Ưu tiên: Nhâm → Canh → Giáp. — 辛金未月，壬庚甲并用',
  '辛申月': 'Thu sơ kim vượng — cần Nhâm Thủy tẩy rửa, Giáp Mộc, Mậu Thổ. Ưu tiên: Nhâm → Giáp → Mậu. — 辛金申月，壬水淘洗为先',
  '辛戌月': 'Quý thu táo — cần Nhâm Thủy nhuận tẩy, Giáp Mộc. Ưu tiên: Nhâm → Giáp. — 辛金戌月，壬甲为用',
  '辛亥月': 'Đông sơ hàn — cần Nhâm Thủy (cùng khí), Bính Hỏa noãn cục. Ưu tiên: Nhâm → Bính. — 辛金亥月，壬丙并用',
  '壬子月': 'Đông thủy cực vượng — cần Mậu Thổ đắp đê, Bính Hỏa noãn giải băng. Ưu tiên: Mậu → Bính. — 壬水冬月，戊丙并用',
  '壬丑月': 'Quý đông hàn thấp — cần Bính/Đinh Hỏa noãn, Giáp Mộc tiết. Ưu tiên: Bính → Đinh → Giáp. — 壬水丑月，丙丁解冻，甲木疏泄',
  '壬卯月': 'Xuân mộc tiết thủy — cần Mậu Thổ ngăn, Tân/Canh Kim sinh nguồn. Ưu tiên: Mậu → Tân → Canh. — 壬水卯月，戊土为堤，辛庚为源',
  '壬辰月': 'Quý xuân — cần Giáp Mộc tiết tú, Canh Kim sinh thủy. Ưu tiên: Giáp → Canh. — 壬水辰月，甲庚为用',
  '壬午月': 'Hạ cực tài vượng (hỏa) — cần Canh/Tân Kim sinh thủy, Quý Thủy trợ. Ưu tiên: Canh → Tân → Quý. — 壬水午月，庚辛生水为先',
  '壬未月': 'Quý hạ táo — cần Tân Kim sinh nguồn, Giáp Mộc. Ưu tiên: Tân → Giáp. — 壬水未月，辛甲为用',
  '壬酉月': 'Thu kim sinh thủy (kim bạch thủy thanh) — cần Giáp Mộc tiết, Canh Kim. Ưu tiên: Giáp → Canh. — 壬水酉月，金白水清，甲木为用',
  '壬戌月': 'Quý thu táo thổ — cần Giáp Mộc, Bính Hỏa. Ưu tiên: Giáp → Bính. — 壬水戌月，甲丙调候',
  '癸丑月': 'Quý đông hàn thấp — cần Bính Hỏa giải đông, Đinh Hỏa phụ. Ưu tiên: Bính → Đinh. — 癸水冬月，丙火解冻',
  '癸卯月': 'Xuân mộc vượng tiết thủy — cần Canh/Tân Kim làm nguồn. Ưu tiên: Canh → Tân. — 癸水卯月，庚辛为源',
  '癸辰月': 'Quý xuân — cần Bính Hỏa noãn, Tân Kim sinh, Giáp Mộc. Ưu tiên: Bính → Tân → Giáp. — 癸水辰月，丙辛甲并用',
  '癸午月': 'Hạ cực — thủy dễ cạn, cần Canh/Tân Kim sinh, Nhâm/Quý Thủy trợ. Ưu tiên: Canh → Tân → Nhâm. — 癸水午月，庚辛壬癸',
  '癸未月': 'Quý hạ táo — cần Canh/Tân Kim làm nguồn, Nhâm/Quý trợ. Ưu tiên: Canh → Tân → Nhâm. — 癸水未月，金水相生为上',
  '癸申月': 'Thu sơ kim vượng — Đinh Hỏa luyện kim (kim có hỏa mới thành khí sinh thủy đẹp). Ưu tiên: Đinh Hỏa. — 癸水申月，专用丁火',
  '癸戌月': 'Quý thu táo — cần Tân Kim, Giáp Mộc, Nhâm/Quý. Ưu tiên: Tân → Giáp → Nhâm. — 癸水戌月，辛甲壬癸',
  '癸亥月': 'Đông sơ thủy vượng — cần Canh/Tân Kim, Mậu Thổ ngăn, Đinh Hỏa noãn. Ưu tiên: Canh → Tân → Mậu. — 癸水亥月，庚辛为源，戊丁调候',
...
export const SHENTOU_LU_NAYIN = {
  ...
  examples: {
    ...
    "丙午": "Binh-Ngo = 'Thien Ha Thuy' → 神頭祿「至陰之水，發於陽明蒸氣氤氳」— nuoc chi am, khi am uan.",
      "甲子": "Giap-Tu = Hai Trung Kim → co ten vo hinh, bao tang.",
    "乙丑": "At-Suu = Hai Trung Kim → vang chua thanh khi.",
    "丙寅": "Binh-Dan = Lo Trung Hoa → hoa lon, can moc.",
    "丁卯": "Dinh-Mao = Lo Trung Hoa → hoa lon, nhe.",
    "戊辰": "Mau-Then = Đai Lam Moc → rung lon, can vuong.",
    "己巳": "Ky-Ty = Đai Lam Moc → lam nhe, đu sinh.",
    "己亥": "Ky-Hoi = Binh Dia Moc → moc chua thanh khi.",
    "庚子": "Canh-Tu = Bich Thuong Tho → dat tuong.",
    "辛丑": "Tan-Suu = Bich Thuong Tho → dat tuong, so hoa.",
    "甲辰": "Giap-Then = Phuc Đang Hoa → hoa nen, can dem.",
    "乙巳": "At-Ty = Phuc Đang Hoa → dang hoa, can moc.",
    "丁未": "Dinh-Vi = Thien Ha Thuy → bom tuoi.",
    "戊申": "Mau-Than = Đai Dich Tho → dat đai đao.",
    "己酉": "Ky-Dau = Đai Dich Tho → đai dich, me nhuoc.",
    "庚戌": "Canh-Tuat = Xoa Xuyen Kim → trang suc, dep.",
    "辛亥": "Tan-Hoi = Xoa Xuyen Kim → trang suc, mem.",
    "壬子": "Nham-Tu = Tang Trach Moc → moc tang, thich thuy.",
    "丁巳": "Dinh-Ty = Sa Trung Tho → đat luoi song.",
    "己未": "Ky-Vi = Thien Thuong Hoa → hoa kho.",
    "庚申": "Canh-Than = Thach Lieu Moc → moc thanh khi.",
    "壬戌": "Nham-Tuat = Đai Ha Thuy → nuoc bien đuc, can son.",
    "癸亥": "Quy-Hai = Đai Ha Thuy → nuoc bien trong, cuc tinh.",
},
...
// ---- [RULE EXTRACT] 滴天髓 specific evaluation patterns (任铁樵评注 deep extract) ----
export const DITIANSUI_PATTERNS = [
{ pattern: '甲木身强无庚,虽有丙火', reading: 'Mộc thân vượng không gặp Canh Kim khắc chế, dù có Bính Hỏa sinh trợ vẫn chỉ thuộc hạng nghệ thuật, tài hoa chứ khó nắm quyền lớn.' },
  { pattern: '甲木得庚,官星透干,坐支有根', reading: 'Giáp Mộc gặp Canh Kim quan tinh thấu can, có căn ở địa chi thì thành quan quý cách, quyền hành vững, không phải chỉ hư danh.' },
  { pattern: '乙木遇庚,无制无合', reading: 'Ất Mộc gặp Canh Kim nếu không có chế hợp thì thân bị khắc nặng, tính cách nhu nhược, dễ gặp áp lực từ cấp trên hoặc chồng.' },
  { pattern: '丙火坐寅,甲木透干无水', reading: 'Bính Hỏa tọa Dần, Giáp Mộc thấu can mà không có Thủy thì sáng rực nhưng dễ khô kiệt, tài hoa sớm nở muộn tàn.' },
  { pattern: '丁火见甲,甲己合而不化', reading: 'Đinh Hỏa gặp Giáp Mộc, nếu Giáp Kỷ hợp mà không hóa thì ấn tinh bị trói, học vấn có mà khó thành đại nghiệp.' },
  { pattern: '戊土得丙,坐辰无甲', reading: 'Mậu Thổ được Bính Hỏa sinh, tọa Thìn mà không có Giáp thì ấm áp ôn hòa, trung niên ổn định, nhưng thiếu đột phá.' },
  { pattern: '己土见甲,甲己合化土,地支得戌', reading: 'Kỷ Thổ gặp Giáp, hợp hóa Thổ mà địa chi có Tuất thì trung chính ôn nhu, dễ được quý nhân nâng đỡ.' },
  { pattern: '庚金见丁,丁火透干无甲', reading: 'Canh Kim gặp Đinh Hỏa thấu can mà không có Giáp Mộc tiếp tục sinh Hỏa thì quan sát rõ ràng, tính quyết đoán nhưng dễ cô độc.' },
  { pattern: '辛金得壬,壬水透干,地支申子', reading: 'Tân Kim được Nhâm Thủy thấu, địa chi Thân Tý thành thực thì thanh tú, mẫn tiệp, thích hợp văn chương kỹ thuật.' },
  { pattern: '壬水见戊,戊土透干坐辰', reading: 'Nhâm Thủy gặp Mậu Thổ thấu, tọa Thìn thì quan tinh có lực, dễ nắm chức vụ quản lý, tính cẩn trọng.' },
  { pattern: '癸水遇丁,丁火合壬而不见戊', reading: 'Quý Thủy gặp Đinh Hỏa, nếu Đinh hợp Nhâm mà không thấy Mậu thì tình cảm phức tạp, duyên lận đận nhưng tâm hồn sâu.' },
  { pattern: '甲寅日主,地支寅午戌全,无水', reading: 'Giáp Dần nhật chủ, địa chi Dần Ngọ Tuất toàn cục không Thủy thì Hỏa vượng thiêu Mộc, công danh sớm nhưng sức khỏe dễ hao.' },
  { pattern: '乙亥日主,透丙见庚', reading: 'Ất Hợi nhật chủ, thấu Bính gặp Canh thì vừa có thực thần vừa có quan, nếu điều hòa thì vừa tài vừa quyền.' },
  { pattern: '丙午日主,见壬透干,地支有申', reading: 'Bính Ngọ nhật chủ, Nhâm thấu can, địa chi có Thân thì Thủy cứu Hỏa khô, trung niên chuyển biến lớn, dễ có danh.' },
  { pattern: '丁巳日主,甲木透干无水无金', reading: 'Đinh Tỵ nhật chủ, Giáp thấu không Thủy không Kim thì ấn vượng sinh thân, học vấn tốt nhưng dễ ỷ lại, thiếu thử thách.' },
  { pattern: '戊辰日主,甲乙透干,无丙丁', reading: 'Mậu Thìn nhật chủ, Giáp Ất thấu mà không Bính Đinh thì quan sát quá mạnh, thân yếu dễ lo lắng, công danh gian nan.' },
  { pattern: '己丑日主,见甲合,地支未戌', reading: 'Kỷ Sửu nhật chủ, gặp Giáp hợp, địa chi có Mùi Tuất thì hợp hóa có lực, tính ôn hòa, dễ thành gia nghiệp vững.' },
  { pattern: '庚申日主,见丁透,甲木有根', reading: 'Canh Thân nhật chủ, Đinh thấu, Giáp có căn thì quan ấn tương sinh, võ dũng có văn, dễ nắm binh quyền hoặc quản lý.' },
  { pattern: '辛酉日主,壬水透干,无戊土', reading: 'Tân Dậu nhật chủ, Nhâm thấu không Mậu thì Thủy tiết Kim khí, thanh cao mẫn cảm, thích hợp nghệ thuật y dược.' },
  { pattern: '壬子日主,见戊透干,地支辰戌', reading: 'Nhâm Tý nhật chủ, Mậu thấu, địa chi Thìn Tuất thì quan tinh hữu lực, trung niên đắc quyền, tính cách cương nghị.' },
  { pattern: '癸亥日主,见丁合,甲木透干', reading: 'Quý Hợi nhật chủ, Đinh hợp, Giáp thấu thì thực ấn tương sinh, tình cảm sâu, dễ có tài văn chương hoặc giáo dục.' },
  { pattern: '甲木用庚,行水运过旺', reading: 'Giáp Mộc lấy Canh làm dụng, đi vận Thủy quá vượng thì Ấn vượng hóa quan, dễ mất quyền hoặc bị cấp dưới lấn át.' },
  { pattern: '丙火身弱,行木运初年', reading: 'Bính Hỏa thân yếu, hành Mộc vận đầu đời thì được Ấn sinh, học hành tiến bộ, nhưng cần phòng Mộc đa hóa Hỏa.' },
  { pattern: '庚金见丙,年干透丁', reading: 'Canh Kim gặp Bính, năm can thấu Đinh thì quan sát trùng điệp, áp lực công danh lớn, dễ có thành tựu nhưng hao tâm lực.' },
  { pattern: '乙木从财,地支辰戌丑未全', reading: 'Ất Mộc tòng tài, địa chi tứ kho toàn thì tài vượng thân tòng, giàu có thực chất, tính thực tế, ít mơ mộng.' },
  { pattern: '壬水伤官见官,地支寅巳', reading: 'Nhâm Thủy thương quan kiến quan, địa chi Dần Tỵ thì Hỏa vượng khắc Kim sinh Thủy loạn, dễ khẩu thiệt, kiện tụng.' },
  { pattern: '甲己合而不化,丙火透干', reading: 'Giáp Kỷ hợp không hóa, Bính thấu thì tài quan tương sinh nửa chừng, duyên tình dễ dở dang, công danh trắc trở giữa đường.' },
  { pattern: '辛金坐子,见戊土透干', reading: 'Tân Kim tọa Tý, Mậu thấu thì Ấn tinh sinh thân, trí tuệ sâu, thích hợp nghiên cứu, nhưng dễ cô độc thanh cao.' },
  { pattern: '丁火见庚,庚金无根,甲木透', reading: 'Đinh Hỏa gặp Canh vô căn, Giáp thấu thì thực thần sinh tài hư, lời hay ý đẹp nhưng khó giữ của, tính lãng mạn.' },
  { pattern: '戊土坐寅,甲木透干,丙火有根', reading: 'Mậu Thổ tọa Dần, Giáp thấu, Bính có căn thì quan ấn tương sinh, vừa có quyền vừa có học, trung niên phát đạt vững.' },
];

// ---- [RULE EXTRACT] 鬼谷子算命术 60甲子 readings ----
export const GUIGU_60JIAZI = {
'甲子': { title: '白玉仙子捧印（天德贵人·海中金）', reading: 'Thông minh lanh lợi, học nhiều nhưng dễ có đầu không có đuôi; tính nóng, tuổi nhỏ nhiều trắc trở. Có quý nhân nâng đỡ, được người kính trọng nhưng giao thiệp hay sóng gió; nam lấy vợ lớn, nữ lấy chồng lớn. Cần kiên nhẫn rèn luyện — như kim dưới biển chờ thời.' },
  '乙丑': { title: '玉女佩珠（福星贵·海中金）', reading: 'Hào phóng, thích xuân phong; học nhiều khó trọn, tuổi nhỏ hay bệnh, ít nhờ lục thân. Ngồi kim khố — có lộc y phục, văn chương; nữ hiền hòa nhưng ham tài. Cần hỏa rèn, tránh nhất ý cô hành.' },
  '丙寅': { title: '红日东升（炉中火）', reading: 'Tâm tính bất định, miệng nhanh lưỡi cứng, thân nhàn lòng thẳng, tay chân không ngừng. Gần quan gần quý, siêng năng có thu hoạch; nữ hiền, thông minh. Như mặt trời mọc — sáng nhưng bị kiêu ấn đoạt thực, cần giữ lửa ôn hòa.' },
  '丁卯': { title: '月照蟾宫（炉中火）', reading: 'Tay chân không nghỉ, trong ngoài vất vả; khéo léo thông minh, việc hay có đầu thiếu đuôi. Nam phúc phận, nữ cầu yên tĩnh trong lao nhọc. Ngồi thiên ấn — học vấn tốt, phù trợ người hơn đứng đầu; đừng tham hư danh.' },
  '戊辰': { title: '苍龙出海（大林木）', reading: 'Hòa khí xuân phong, gần quan gần quý; lục thân có hình, con cái không cô. Nữ ôn lương, miệng quạ lòng đậu hũ — dễ bị hiểu lầm. Ngồi tài quan tỉ kiếp, đất ẩm có hỏa — gốc sâu lá tốt, nhiệt tình phúc hậu.' },
  '己巳': { title: '马跃平川（大林木·金神）', reading: 'Thông minh tay chân lanh; nhỏ có công danh, việc suôn sẻ, vợ chồng hòa. Nam hay ra mặt, mưu cơ; nữ đủ ăn mặc, lương thiện. Kim thần quý — cương nghị; thương quan đeo ấn, quý nhưng dễ gặp tiểu nhân.' },
  '庚午': { title: '火铸金印（路旁土）', reading: 'Miệng nhanh lòng thẳng, gần quan gần quý, y lộc dư dả. Nam có quyền, ngoài cứng trong siêng; nữ tuấn tú, lợi chồng con. Vàng ngồi lửa — quan ấn song toàn nhưng phải rèn trăm lần; đường quan lộ thăng trầm.' },
  '辛未': { title: '冰河解冻（路旁土）', reading: 'Có chí khí, lòng khoan dung nhân nghĩa; tuổi nhỏ bệnh, trung niên khá. Vợ chồng hòa, sự nghiệp thuận; nữ giữ nhà mới thịnh. Ngồi thiên tài thiên sát — tiểu quý; nữ chuyên tình, nắm quyền trong nhà.' },
  '壬申': { title: '白虎渡江（剑锋金）', reading: 'Khéo léo thông minh, mưu nhiều, thành tín; có vợ hiền, được người ưa. Giai đoạn phú quý, con cháu phúc. Nạp âm kiếm phong — dám đánh dám tranh, dễ không thiện chung; nữ có khí chất nam.' },
  '癸酉': { title: '天福日（剑锋金）', reading: 'Lòng thẳng công bằng, miệng lưỡi sắc — phòng nói nhiều mất; y lộc tự kiệm, ổn định đủ dùng. Lục thân lạnh nhạt, tự mưu sinh; giao thiệp được mến. Ngoài mềm trong sâu, biết kiếm cũng biết tiêu; nữ trợ phu, già an.' },
  '甲戌': { title: '青龙献艺（山头火）', reading: 'Miệng nhanh, thân nhàn lòng không trống; tuổi nhỏ nghèo, trung niên bôn ba, hơi có quyền. Học nhiều ít thành, danh nhỏ; già phúc lộc. Cương trực quang minh, quan thanh — nhưng thẳng quá dễ đắc tội, hay bị đố kỵ.' },
  '乙亥': { title: '名利双成（山头火）', reading: 'Hòa thuận, tuổi nhỏ nhiều nạn, cha mẹ có hình; thật thà ra ngoài khá hơn. Nữ chồng tốt, chung thủy; trung niên tài vượng, phòng lao thành bệnh. Khô mộc gặp xuân — nam được hiền thê, nữ được quý phu, nhan sắc.' },
  '丙子': { title: '漓江照彩（涧下水·福星）', reading: 'Gan lớn, mưu cơ nhiều, tâm cơ thâm; sớm bình, trung niên thành, già rất tốt. Nữ nhiều lời — giữ phận thì phúc tự đến. Thông minh bác học, dễ uy vọng; tính lưỡng diện, ngồi chính quan dễ chuyên quyền.' },
  '丁丑': { title: '玉女守库（涧下水）', reading: 'Hòa hợp, y lộc không lo; sớm có lộc, già rất tốt, có dư. Kết hôn muộn, con muộn; vợ chồng hòa. Nữ vượng phu yêu tử, hiền lương. Ngồi thực thần sinh thiên tài — cát; thân yếu nhưng sao sáng không ngại.' },
  '戊寅': { title: '虎啸山谷（城头土）', reading: 'Tính mãnh liệt, cương cường dễ chiêu họa; nóng lạnh thất thường, giao tạp. Sớm siêng xa tổ phát; thông minh tay chân lanh; già có cơ hội — đừng nóng nảy. Như hổ gầm — võ công, chinh chiến; xuân sinh sát nặng, lao vì người.' },
  '己卯': { title: '武跨将坛（城头土）', reading: 'Giao thiệp rộng, phong lưu hào kiệt, y lộc đủ; lục thân lạnh, tự lập. Nữ chú ý láng giềng, ngực rộng sống lâu. Ngồi sát cắt chân — ngày kém: dễ tật, thương, cả đời lao khổ; cần cẩn trọng sức khỏe và an toàn.' },
  '庚辰': { title: '福德贵人（魁罡·白蜡金）', reading: 'Xuân phong hòa khí, lao lộc sương tuyết; gần quan gần quý, danh lợi song toàn. Trung bình, già hưng; nữ siêng giữ nhà. Quỵ cương — cương cường, không tin quỷ thần; tài lộc học thức, có thể làm quan nhưng ẩn thương quan.' },
  '辛巳': { title: '金马登殿（白蜡金）', reading: 'Thân thiện mưu cơ, ứng biến nhanh, chí khí hơn người; y lộc đủ, có quý nhân. Trung hòa, già phúc, tri túc trường thọ. Quan ấn kiếp — yếu chuyển mạnh, cân bằng; chủ quan quý, dễ thành công.' },
  '壬午': { title: '花红柳绿（杨柳木）', reading: 'Siêng kiệm, cha mẹ hình; sớm tài không suôn, trung niên lao tâm, già con vượng. Nữ hưng gia, hằng tâm có được. Ngồi tài quan — quan quý; hợp tài vợ, vì vợ phú. Nhưng thủy che hỏa — thăng trầm lớn.' },
  '癸未': { title: '贵人佩玉（杨柳木）', reading: 'Tâm gấp miệng nhanh, lanh lợi; cứu người không ân, hay bị hiểu lầm. Tài không kho — đến rồi đi; tính toán kỹ tránh họa. Nữ hiền giữ nhà. Giai tuấn, tình chuyên nhưng tái hôn khá nhiều.' },
  '甲申': { title: '龙虎夺魁（泉中水）', reading: 'Y lộc không thiếu, tính ôn nhu, kỹ nghệ hơn người; sớm không thuận, trung lao, già lợi. Vợ chồng hòa, con muộn. Ngồi tuyệt địa — cả đời bôn ba vất vả; mộc chết gặp sát đẽo vẫn dùng được.' },
  '乙酉': { title: '龙凤呈祥（泉中水）', reading: 'Miệng nhanh lòng thẳng, hào sảng lạc quan; y lộc đủ, anh em khó giúp. Làm thiện việc thành; nữ hưng vượng, tích tiểu. Tự tọa thất sát cắt chân — nhiều tật, khó thiện chung; nữ đẹp lãng mạn, tình duyên lận đận.' },
  '丙戌': { title: '天厨贵人（屋上土）', reading: 'Tính ôn hòa, kỹ nghệ nuôi thân, y lộc không lo; tự lập. Sớm không thuận, trung lao có tiến; già vinh. Nữ trung bôn ba, già hơi tụ. Hỏa khố sáng — thông minh đẹp, duyên; sinh nghèo trung phát, sinh giàu trung suy.' },
  '丁亥': { title: '月照天门（屋上土）', reading: 'Khéo léo thông minh, tiểu tài trí; tự lập bôn ba, con muộn mới tốt. Làm thiện, hơi vượng tài; nữ trinh tiết được quý nhân. Quan ấn tương sinh — siêu quần; hợp hóa ấn, duyên đại quý; nữ gả quý phu.' },
  '戊子': { title: '山环水抱（六秀·霹雳火）', reading: 'Tính toán thông minh, văn võ lưỡng thông; con sớm phòng khắc, kết hôn sớm. Tài vận tốt nhưng tình không chuyên. Lục tú — tú khí; ngồi chính tài, được hiền thê vì vợ phú; hóa hỏa sinh thân, cao quý.' },
  '己丑': { title: '金牛拜殿（霹雳火）', reading: 'Miệng nhanh lòng thẳng, thông kỹ nghệ, nắm thực quyền; thành ý được chúng vọng. Y lộc không thiếu; nam phòng tái thú. Thiện lương, trách nhiệm, nội hướng tỉ mỉ; chậm rãi nhưng khí chất cao nhã cả thuận lẫn nghịch.' },
  '庚寅': { title: '白虎镇山（松柏木）', reading: 'Tính gấp, miệng không lòng, dễ giận dễ nguôi; kết duyên cũng mất duyên. Y lộc đủ; sớm không tụ, trung bôn, già phong. Ngồi tuyệt — nữ khắc phu, nam khó thiện chung; sát ấn có chí khai phá, quan thanh liêm.' },
  '辛卯': { title: '凤阙早步（松柏木）', reading: 'Miệng nhanh lòng thẳng, có chí có quyền, gần quan gần quý; lục thân ít nhờ, tự lập. Sớm lao, già lợi lớn. Ngồi thiên tài — đào hoa; nam ham sắc, nữ đẹp dễ chiêu ong bướm. Phúc quý song toàn nếu giữ mình.' },
  '壬辰': { title: '山流水长（壬骑龙背·长流水）', reading: 'Lao lộc, tay chân không nghỉ; sớm khó giữ tài, già phát. Nữ cầm gia siêng. Ngồi thủy khố thân vượng — thực chế sát, thân vượng dụng sát chủ quý. Ngọ thì rồng chết kém; hợi thì long quy hải chủ đại quý.' },
  '癸巳': { title: '彩霞佩玉（日贵·长流水）', reading: 'Thông minh gần quý nhân; trung niên sương gió, phải giữ nghiệp đã thành. Tốt bụng bị phản; già khá. Tài quan ấn liên sinh — cao quý giàu có; nữ gả quý phu. Phòng bệnh vợ chồng, rượu sắc.' },
  '甲午': { title: '龙马奔驰（沙中金）', reading: 'Hòa khí, thích vui chơi; xuân dễ phong đãng, gần quan gần quý, hung hóa cát. Nữ miệng nhanh, phòng họa tình. Ngồi tử địa — lao bôn cả đời; thương quan sinh tài hiếu thảo, lo người hơn lo mình, già dễ tay không.' },
  '乙未': { title: '财福日（沙中金）', reading: 'Sớm siêng, anh em ít nhờ, con không cô; già tụ tài hưng vượng. Nữ giữ nhà, tính toán. Ngồi khố thông căn — tài nhập khố chủ phú; yêu tiền hơi keo; xung khố thì phát tài.' },
  '丙申': { title: '火照金城（山下火）', reading: 'Y thực dư, đường lợi thông, kỹ năng sinh tài; sớm lao lộc. Nữ giữ nhà siêng. Thân yếu không căn — thực sinh tài, tài sinh sát; thông minh linh khí. Sát vượng công thân — già cô, không ngồi hưởng nhàn.' },
  '丁酉': { title: '玉女乘凤（山下火）', reading: 'Thích thể diện, đa tình trọng ân, duyên lạ; gần quan gần quý. Sớm lao, thân nhàn lòng khổ; già hưng, con có ích. Ngồi trường sinh thiên tài, dạ quý văn xương — cao quý, kiến thức vượt; tính phản nghịch sáng tạo.' },
  '戊戌': { title: '溪绕画亭（魁罡·平地木）', reading: 'Hòa khí tự lập; sớm điên đảo hao tài, trung tham vọng bị đố kỵ. Khổ học kỹ nghệ là mệnh. Quỵ cương — miệng nhanh quyết đoán, văn chương chấn; xử sự thiếu uyển chuyển dễ đắc tội. Cát lẫn hung.' },
  '己亥': { title: '平川流水（平地木）', reading: 'Khéo léo, y thực ổn; lục thân lạnh, con sớm khắc muộn mới tốt. Vợ chồng hòa; nữ thanh nhàn già tốt. Ngồi chính tài chính quan — tài quan song mỹ chủ quý; nữ gả được quý phu.' },
  '庚子': { title: '金玉出海（壁上土）', reading: 'Trầm trọng ổn, y lộc không thiếu; vợ hiền giữ nhà, kết quý nhân, hung hóa cát. Nữ hưng vượng gia. Ngồi thương quan — nữ khắc phu; kim thủy tương sinh tú lệ thông minh, nghĩa khí; hợp pháp lý, kiểm tra.' },
  '辛丑': { title: '白玉生辉（壁上土）', reading: 'Tính ôn hòa; sớm phòng kinh sợ tai bất ngờ. Có y lộc, lục thân ít lực; già tốt. Nữ vượng gia. Thông căn, ấn tỉ thực — linh tú; nữ dáng đẹp giữ nhà. Xa hợp quan tinh, cần xem kỹ thân vận.' },
  '壬寅': { title: '福禄日（壬骑虎背·金箔金）', reading: 'Miệng nhanh lòng thẳng; không kết hôn sớm — sớm khắc. Con muộn, sớm điên đảo, trung hưng. Nữ như ý phát phúc. Thực sinh tài sinh sát — phú quý song toàn; can chi tương sinh, gia đình viên mãn.' },
  '癸卯': { title: '天姿文秀（日贵·金箔金）', reading: 'Y thực không thiếu, hung hóa cát; sớm không thuận, già tốt. Nữ cầm gia, bị đố kỵ. Ngồi trường sinh nhật quý, thực thần thổ tú — thông minh văn tài, ôn hòa trung hậu, duyên tốt. Vợ chồng ân ái, con học thành.' },
  '甲辰': { title: '龙守财库（覆灯火）', reading: 'Y thực dư, lòng thanh nhàn; sớm yếu, trung siêng, tình có sóng, nghiệp phát. Kết hôn muộn, con muộn. Thông căn — thiên tài phá ấn, thiếu quý khí; nửa đời trước kém, sau bình an, tài lộc đủ.' },
  '乙巳': { title: '木火生辉（覆灯火）', reading: 'Thích thể diện, cứu người không công; con sớm khắc, già an. Nữ trợ phu. Hướng dương hoa nở — thông minh, tiết khí lợi người hơn mình. Thương quan tài quan — giàu; nam muộn hôn được hiền thê, tính cương dễ phạm kỷ.' },
  '丙午': { title: '天河落彩（天河水）', reading: 'Thân nhàn lòng không trống; sớm hao tài, nên lập nền kỹ nghệ; cầu danh bất lợi, tranh chấp anh em. Nữ thanh tú tư duy lạ. Ngồi dương nhẫn quá cương — thông minh văn tài; nam khắc thê nữ khắc phu, dễ thương tật.' },
  '丁未': { title: '人立画桥（天河水）', reading: 'Vui giận thất thường, miệng lưỡi; danh lợi không thiếu, lục thân xa, con muộn. Y lộc dư; nữ vượng vận siêng hưng gia. Ngồi khố dương nhẫn — ương ngạnh không chịu thua; thực thần vượng, đẹp hay ăn; nữ hiền.' },
  '戊申': { title: '霞落花簇（大驿土）', reading: 'Tính gấp, hay đổi; cả đời lao, gần quan gần quý; con hình, tài khố đủ. Nữ vượng vận siêng. Thổ hầu cô độc — nữ sớm ly hoặc cô; nam khá hơn. Đẹp nhưng tình không chuyên, tác phong dễ lệch.' },
  '己酉': { title: '凤飞绿洲（大驿土）', reading: 'Thông minh, y lộc dư; lục thân ít nhờ, con sớm. Lượng rộng trăm việc thông; nữ kỹ xảo nhiều biến, ít tai. Ngồi trường sinh văn xương — hay văn, thông minh; thổ kim tương sinh thân khỏe. Quý xuân sinh, quý gặp ấn.' },
  '庚戌': { title: '禄马贵人（魁罡·钗钏金）', reading: 'Vui vẻ, phòng tai sửu mùi; gần quan gần quý, lanh lợi; phúc già, cứu người ít nghĩa. Nữ hiền siêng mới hưng. Quỵ cương — thông minh cương nghị, trung nghĩa; thành bại lớn, chấp nhất mạnh, ít tri kỷ.' },
  '辛亥': { title: '虎行天门（钗钏金）', reading: 'Không dính việc rỗi, thanh tĩnh thủ trung; sớm không tụ tài, già vinh hoa. Nữ siêng phúc, trợ lập nghiệp. Kim thủy liên — văn tài tốt; nữ ngồi tắm, thương quan vượng bất lợi phu. Nam được thê tài hoặc thê đẹp.' },
  '壬子': { title: '马奔天河（桑柘木）', reading: 'Tuổi nhỏ hiện tai, trung y thực đủ; nam có vợ tốt, thân nhàn lòng lao, bôn ba. Anh em ít lực; nữ hiền phòng đố kỵ. Ngồi nhẫn kiếp — thủy quá vượng, đẹp; nữ không giữ nhà, nam hiếu sắc; kinh doanh được mất.' },
  '癸丑': { title: '桑柳成荫（桑柘木）', reading: 'Y lộc không thiếu, được kính trọng; đừng gây thị phi, cha mẹ khó, lục thân ít nhờ. Vợ chồng hòa, con muộn; tài sớm khó tụ. Ngồi khố dương nhẫn — tú khí; sát ấn sinh tỉ, lợi huynh đệ, làm việc vất vả không được khen.' },
  '甲寅': { title: '天禄贵人（日德·大溪水）', reading: 'Thành thực, gần quan gần quý, nhà hưng; cha mẹ có lợi. Nam sợ vợ, mệnh cứng; nữ quản chồng, con hưng. Ngồi lộc thân vượng — học nhiều năng; thực sinh thiên tài chủ phú quý. Nhật đức — từ thiện, gặp hung có cứu.' },
  '乙卯': { title: '风云相会（大溪水）', reading: 'Chí khí hiên ngang, y lộc dư; mưu xảo, lời có dối; văn võ hai ngành, gập ghềnh nhưng việc lớn thành. Nữ phúc, siêng thêm thọ. Ngồi lộc thân vượng tỉ kiếp — thanh quý không giàu; văn tài, dáng tú; cẩn hôn nhân.' },
  '丙辰': { title: '火照龙潭（日德·沙中土）', reading: 'Thông minh tay chân lanh, y lộc không thiếu; thân nhàn lòng lao, thích kết bạn; trung hưng. Nữ hiền siêng lập gia. Ngồi quỵ, quan khố — thông minh hiếu động, sớm phát sớm thương; nhật đức, quang chiếu vạn vật.' },
  '丁巳': { title: '朱雀跃辉（沙中土）', reading: 'Cương cường, gần quan gần quý; tính xảo khó thuận; anh em trưởng, nghiệp hiển. Nữ hiền siêng, phòng có đầu không đuôi. Dương thịnh âm suy — ban ngày kém sáng; hay gặp quan sát họa, gặp âm mộc có cứu; khắc lục thân.' },
  '戊午': { title: '马奔午门（天上火）', reading: 'Ôn lương, chí rộng, y lộc dư; sớm nhiều tai, lục thân hình, vợ chồng khắc. Trung siêng có thu; già con hiếu. Ngồi dương nhẫn quá vượng — nữ khắc phu nam khắc thê, dễ thương tai; tính phù táo, gặp ấn phúc trung họa.' },
  '己未': { title: '丹桂飘香（天上火）', reading: 'Miệng nhanh lưỡi cứng, y lộc nhỏ; có quý nhân, siêng nghiệp, tính toán kỹ, tài không dứt. Ngồi khố thân vượng dương nhẫn — dễ khắc cha; sát ấn, ý thức bản ngã mạnh. Nữ dáng đẹp; không thực thương khó nuôi con.' },
  '庚申': { title: '双虎奔驰（石榴木）', reading: 'Tay chân không nghỉ, thanh cao, gần quan gần quý; vợ chồng nhiều lời. Làm thiện khó được báo, cứu người không công. Ngồi lộc thông căn — thân khỏe, phú quý. Thiên nguyệt đức — ít bệnh; nữ sinh quý tử. Dục vọng nhiều, dễ chiêu trộm.' },
  '辛酉': { title: '凤卧金山（石榴木）', reading: 'Lanh lợi khí sắc thanh, gian nan lập nghiệp, tự mưu cao kiến; miệng lưỡi được kính, tài lực lớn. Lục thân lạnh. Ngồi lộc — thông minh năng lực. Bạch hổ lâm đình — nam khắc thê nữ khắc phu; dễ rượu sắc, hôn nhân lận đận.' },
  '壬戌': { title: '龙出苍海（大海水）', reading: 'Thích làm thiện, đi khắp, lòng lao nhiều; y thực không thiếu, kết quý nhân. Sớm bình, trung lao, già tốt. Nữ hiền siêng. Tài sinh sát, sát sinh ấn — đại quý hoặc võ quý. Hay xen việc người; kỵ quỵ cương; thê thủ tài.' },
  '癸亥': { title: '天门悬彩（大海水）', reading: 'Cương trực, nói thẳng không nể; lục thân xa, giao nhạt. Tự lập nghiệp; nữ duyên vượng, gia gập ghềnh. Thành tín, phòng lừa; giữ sức khỏe. Ngồi nhẫn — thích độc đoán; nam bất lợi thê, nữ hợi nhiều khắc phu; hôn nhân dễ biến.' },
};


// ====================================================================
//  [QUALITY DEEP] 3 foundational BaZi classics — 67 rules distilled
// ====================================================================
export const ZIPING_CLASSICS_DEEP = [
{ source: '子平真诠', rule: 'Dùng thần (用神) lấy từ nguyệt lệnh (月令) là gốc: lấy khí chính của tháng sinh làm trung tâm luận mệnh, không lấy nhật chủ làm gốc chọn dùng thần.', application: 'Bước đầu phân tích lá số: xác định nguyệt lệnh và khí chính trước khi chọn dùng thần.' },
  { source: '子平真诠', rule: 'Nguyệt lệnh thấu can thì lấy thấu can làm cách cục (格局); không thấu thì lấy tàng can trong địa chi tháng theo thứ tự khí vượng.', application: 'Khi xác định cách cục từ tháng sinh: ưu tiên thiên can thấu xuất, không thì lấy tàng can.' },
  { source: '子平真诠', rule: 'Cách cục thành khi dùng thần được sinh, được hộ, không bị khắc phá; bại khi dùng thần bị khắc, bị hợp mất hoặc bị xung.', application: 'Đánh giá thành bại cách cục sau khi đã chọn dùng thần.' },
  { source: '子平真诠', rule: 'Cách cục bại có thể cứu ứng (救应): dùng thần bị khắc thì cần ấn bảo, bị hợp thì cần xung giải, bị tiết thì cần quan sát cân bằng.', application: 'Khi cách cục hỏng nhưng có thần cứu — luận mức độ cứu ứng.' },
  { source: '子平真诠', rule: 'Thương quan kiến quan (伤官见官), vi họa bách đoan: thương quan khắc quan tinh, gặp nhau thường sinh rắc rối về pháp lý, miệng tiếng, xung đột quyền lực.', application: 'Khi lá số có cả thương quan và quan tinh thấu xuất hoặc đồng hiện.' },
  { source: '子平真诠', rule: 'Thương quan kiến quan có thể hóa giải nếu có ấn tinh chế thương quan, hoặc quan sát quan sát quan sát quan sát — khi ấn chế thương thì quan được bảo.', application: 'Khi thương quan kiến quan nhưng có ấn tinh hộ quan.' },
  { source: '子平真诠', rule: 'Sát ấn tương sinh (杀印相生): thất sát sinh ấn, ấn sinh thân — là cách tốt, biến hung thành cát, thân vượng nhờ ấn, sát hóa thành quyền.', application: 'Khi thất sát và ấn tinh cùng hiện, sát sinh ấn, ấn sinh nhật chủ.' },
  { source: '子平真诠', rule: 'Thực thần chế sát (食神制杀): thực thần khắc thất sát — thân yếu có sát thì cần thực chế; thân vượng sát yếu thì thực chế có thể làm mất quyền.', application: 'Khi có thực thần và thất sát; cân thân vượng nhược để luận tốt xấu.' },
  { source: '子平真诠', rule: 'Thực thần chế sát thành cách khi thân vượng, sát có lực, thực có lực chế sát mà không chế quá; bại khi thực yếu hoặc sát quá vượng không chế nổi.', application: 'Đánh giá thành bại cách thực thần chế sát.' },
  { source: '子平真诠', rule: 'Thương quan phối ấn (伤官配印): thương quan tiết thân, ấn chế thương — cách này hóa hung thành cát, thường chủ thông minh có học, có thành tựu.', application: 'Khi có thương quan và ấn tinh, ấn chế thương quan.' },
  { source: '子平真诠', rule: 'Thương quan sinh tài (伤官生财): thương quan sinh tài tinh — cách tốt nếu thân có thể gánh, chủ phát tài qua tài năng, kỹ thuật, khẩu tài.', application: 'Khi thương quan và tài tinh liên hệ sinh xuất.' },
  { source: '子平真诠', rule: 'Thương quan sinh tài kỵ gặp quan sát — vì thương quan kiến quan lại thêm tài sinh quan, họa càng nặng.', application: 'Khi thương quan sinh tài đồng thời có quan tinh.' },
  { source: '子平真诠', rule: 'Chính quan phối ấn (官印相生): quan sinh ấn, ấn sinh thân — cách cục ổn định, chủ quý, chức vị, học hành tốt.', application: 'Khi chính quan và ấn tinh cùng hiện và tương sinh.' },
  { source: '子平真诠', rule: 'Tài quan song mỹ (财官双美): tài sinh quan, quan hộ thân hoặc thân gánh được — chủ phú quý song toàn nếu không bị phá.', application: 'Khi tài tinh và quan tinh cùng có lực và tương sinh.' },
  { source: '子平真诠', rule: 'Tài phá ấn (财破印): tài khắc ấn — ấn bị phá thì học hành, quý khí, sức khỏe tinh thần suy; nặng khi tài vượng ấn yếu.', application: 'Khi tài tinh khắc ấn tinh, đặc biệt ấn là dùng thần.' },
  { source: '子平真诠', rule: 'Tỷ kiếp đoạt tài (比劫夺财): tỷ kiên, kiếp tài tranh đoạt tài tinh — chủ hao tài, bị tranh, hợp tác dễ mất phần.', application: 'Khi tỷ kiếp vượng và tài tinh yếu hoặc bị vây.' },
  { source: '子平真诠', rule: 'Nhật chủ vượng nhược quyết định dùng thần hướng: thân vượng ức quan/sát/tài/thương; thân nhược phù ấn/tỷ kiếp.', application: 'Sau khi xác định thân vượng nhược, chọn hướng ức phù.' },
  { source: '子平真诠', rule: 'Phù ức (扶抑) là pháp lấy dùng thần phổ biến: phù thân nhược, ức thân vượng; không chỉ nhìn một thần mà xem toàn cục cân bằng.', application: 'Khi luận điều hòa nhật chủ, không thuộc cách cục đặc biệt.' },
  { source: '子平真诠', rule: 'Tòng cách (从格): thân cực nhược vô căn có thể tòng tài, tòng sát, tòng nhi (儿) — lúc này không phù thân mà thuận thế cực đoan.', application: 'Khi nhật chủ vô căn, cực nhược, toàn cục một khí áp đảo.' },
  { source: '子平真诠', rule: 'Hóa cách (化格): can hóa thành khí khác nhờ hợp hóa (như giáp kỷ hợp thổ) — phải tháng lệnh hỗ trợ hóa thần và không bị phá hóa.', application: 'Khi có hợp hóa và nguyệt lệnh thành hóa.' },
  { source: '子平真诠', rule: 'Dụng thần hữu lực tại địa chi, thấu can càng rõ; dụng thần phù du (chỉ thấu không căn) thì lực yếu, đại vận địa chi bổ cứu mới phát.', application: 'Đánh giá lực lượng dùng thần qua căn khí và thấu xuất.' },
  { source: '子平真诠', rule: 'Kỵ thần vượng thì mệnh trắc trở; đại vận lưu niên chế kỵ, sinh dụng thì phát; đại vận sinh kỵ, khắc dụng thì suy.', application: 'Luận đại vận lưu niên theo quan hệ với dụng thần kỵ thần.' },
  { source: '子平真诠', rule: 'Thất sát hữu chế hóa thì thành quyền; vô chế hóa, sát quá vượng thân nhược thì chủ hung họa, bệnh tật, áp lực.', application: 'Khi thất sát hiện — kiểm chế hóa (thực thương chế hoặc ấn hóa).' },
  { source: '子平真诠', rule: 'Chính quan thanh thuần (quan tinh một mình, không tạp sát, không thương quan phá) thì quý; quan sát hỗn tạp thì cách cục bất tịnh.', application: 'Khi có chính quan — kiểm tạp sát và thương quan phá quan.' },
  { source: '三命通会', rule: 'Thần sát không thay thế thập thần và cách cục: dùng thần sát để bổ sung chi tiết, không lấy thần sát làm gốc luận mệnh.', application: 'Khi đọc các sao thần sát — luôn neo vào thập thần và dụng thần trước.' },
  { source: '三命通会', rule: 'Đào hoa (桃花) chủ duyên sắc, ngoại giao, nghệ thuật; tốt khi thân vượng có chế, xấu khi thân nhược hoặc gặp sát tinh — dễ đắm, thị phi sắc dục.', application: 'Khi có đào hoa tinh, kết hợp thân vượng nhược và sát tinh.' },
  { source: '三命通会', rule: 'Hồng loan chủ hôn nhân, duyên lành; gặp đào hoa càng mạnh về tình duyên; cần xem cung thê thiếp và tài quan để luận thực chất hôn nhân.', application: 'Khi có hồng loan — đối chiếu cung hôn nhân và thập thần liên quan.' },
  { source: '三命通会', rule: 'Dịch mã (驿马) chủ biến động, di chuyển, thay đổi môi trường; gặp quan sát thì bôn ba vì công danh, gặp tài thì vì tiền bạc.', application: 'Khi có dịch mã — xem thập thần đi kèm để biết lý do biến động.' },
  { source: '三命通会', rule: 'Hoa cái (华盖) chủ cô độc, tâm linh, nghệ thuật, tư duy sâu; tốt cho học thuật tôn giáo, xấu dễ cô liêu nếu không có giải.', application: 'Khi có hoa cái — luận hướng nghề và tính cách nội tâm.' },
  { source: '三命通会', rule: 'Thiên ất quý nhân (天乙贵人) là quý nhân tối cao, chủ được giúp đỡ, hóa giải tai ương; lực mạnh khi quý nhân có căn khí và không bị xung hợp mất.', application: 'Khi có thiên ất — đánh giá căn khí và xung hợp.' },
  { source: '三命通会', rule: 'Văn xương (文昌) chủ học vấn, văn chương, thi cử; gặp ấn quan càng tốt cho công danh học hành.', application: 'Khi có văn xương kết hợp ấn quan.' },
  { source: '三命通会', rule: 'Dương nhẫn (羊刃) là khí cực vượng của tỷ kiếp, chủ quyết liệt, đao binh, tai nạn nếu vô chế; hữu chế (quan sát chế nhẫn) thì thành uy quyền.', application: 'Khi có dương nhẫn — kiểm chế hóa bằng quan sát.' },
  { source: '三命通会', rule: 'Không vong (空亡) làm suy yếu chi bị không: cung vị, thập thần trong chi không vong giảm lực; đại vận lấp không thì phát, nhập không thì suy.', application: 'Khi chi rơi không vong theo tuần nhật trụ.' },
  { source: '三命通会', rule: 'Nạp âm (纳音) bổ sung tầng lớp ngũ hành ẩn của can chi: cùng trụ nạp âm và can chi có thể khác hành — dùng để tinh chỉnh tính chất, không lật đổ thập thần.', application: 'Khi cần luận sâu tính chất trụ hoặc quan hệ nạp âm giữa các trụ.' },
  { source: '三命通会', rule: 'Nạp âm 60 giáp tý có cách đọc riêng theo cặp can chi (như Giáp Tý Kim bạc, Ất Sửu Kim biển): dùng cho luận vận khí tinh tế và hợp khắc nạp âm.', application: 'Khi đối chiếu nạp âm giữa niên nguyệt nhật thời hoặc đại vận.' },
  { source: '三命通会', rule: 'Nạp âm tương sinh hỗ trợ cát khí ẩn; nạp âm tương khắc báo hiệu xung đột ngầm dù thập thần bề mặt có vẻ hòa.', application: 'Khi thập thần hòa mà vận trình trắc trở — kiểm nạp âm khắc.' },
  { source: '三命通会', rule: 'Thập thần định vị cung: niên trụ luận tổ tiên, cha mẹ sớm, xã hội; nguyệt trụ luận huynh đệ, sự nghiệp trung niên khởi; nhật chi luận thê thiếp, nội tâm; thời trụ luận con cái, hậu vận.', application: 'Khi luận cung vị và giai đoạn đời sống theo trụ.' },
  { source: '三命通会', rule: 'Thập thần ở niên trụ ảnh hưởng sớm và gốc; cùng thần ở thời trụ ảnh hưởng muộn và kết — vị trí quyết định thời điểm phát lực.', application: 'Khi cùng một thập thần xuất hiện ở nhiều trụ.' },
  { source: '三命通会', rule: 'Quan sát tại thời trụ chủ con cái, danh tiếng muộn; tài tinh tại nhật chi chủ thê tài; ấn tại nguyệt trụ chủ học hành, mẹ, nền tảng sự nghiệp.', application: 'Khi định nghĩa quan hệ người và sự việc theo cung thập thần.' },
  { source: '三命通会', rule: 'Thần sát đồng cung với thập thần thì tăng nghĩa: ví dụ sát tinh + dương nhẫn tăng hung hiểm; quan tinh + quý nhân tăng quý khí thực.', application: 'Khi thần sát và thập thần cùng trụ hoặc cùng chi.' },
  { source: '三命通会', rule: 'Tam kỳ quý nhân (thiên địa nhân kỳ: Giáp Mậu Canh, Ất Bính Đinh, Nhâm Quý Tân) chủ thông minh, quý hiển đặc biệt khi hội đủ và không bị phá.', application: 'Khi can có tổ hợp tam kỳ.' },
  { source: '三命通会', rule: 'Cô thần quả tú chủ cô độc, ly tán; luận hôn nhân con cái cần kết hợp đào hoa, hồng loan, tài quan thê tinh — không chỉ dựa một sao.', application: 'Khi có cô thần quả tú — đối chiếu toàn cục hôn nhân.' },
  { source: '渊海子平', rule: 'Nhật can là chủ mệnh (nhật chủ); thập thần tính theo quan hệ ngũ hành và âm dương với nhật can: sinh ta ấn, ta sinh thực thương, khắc ta quan sát, ta khắc tài, cùng ta tỷ kiếp.', application: 'Bước đầu gán nhãn thập thần cho mọi can chi.' },
  { source: '渊海子平', rule: 'Chính ấn thiên ấn: ấn sinh thân, chủ học vấn, bảo hộ, mẹ, quý khí; quá nhiều ấn dễ ỷ lại, thiếu quyết đoán.', application: 'Khi luận ấn tinh trong lá số.' },
  { source: '渊海子平', rule: 'Thực thần thương quan: thân sinh ra, chủ tài hoa, biểu đạt, con cái, tiết khí thân; thực thần ôn hòa, thương quan sắc sảo dễ khắc quan.', application: 'Khi luận thực thương và phân biệt thực vs thương.' },
  { source: '渊海子平', rule: 'Chính quan thất sát: khắc thân, chủ kỷ luật, chức quyền, chồng (nữ mệnh); chính quan chính đáng, thất sát mãnh liệt hung hơn nếu vô chế.', application: 'Khi luận quan sát và sự nghiệp/hôn nhân nữ.' },
  { source: '渊海子平', rule: 'Chính tài thiên tài: thân khắc, chủ tiền bạc, thê (nam mệnh), dục vọng; chính tài ổn định, thiên tài bất thường, cơ hội ngoài luồng.', application: 'Khi luận tài tinh và quan hệ vợ/chồng nam.' },
  { source: '渊海子平', rule: 'Tỷ kiên kiếp tài: cùng khí với thân, chủ huynh đệ, bạn bè, cạnh tranh; tỷ kiên hòa, kiếp tài cướp đoạt mạnh hơn.', application: 'Khi luận tỷ kiếp và quan hệ ngang hàng.' },
  { source: '渊海子平', rule: 'Cách cục cơ bản phân theo khí tháng lệnh: quan sát cách, tài cách, ấn cách, thực thương cách, kiến lộc dương nhẫn cách — mỗi cách có điều kiện thành bại riêng.', application: 'Khi phân loại cách cục sơ bộ từ nguyệt lệnh.' },
  { source: '渊海子平', rule: 'Chính quan cách: tháng lệnh quan tinh, thân vượng gánh quan, có ấn sinh thân hoặc tài sinh quan vừa đủ — chủ công danh ổn.', application: 'Khi nguyệt lệnh là chính quan.' },
  { source: '渊海子平', rule: 'Thất sát cách: tháng lệnh sát, cần thực thương chế hoặc ấn hóa; thân vượng sát chế thì nắm quyền lực.', application: 'Khi nguyệt lệnh là thất sát.' },
  { source: '渊海子平', rule: 'Tài cách: tháng lệnh tài, thân vượng mới gánh nổi tài; có quan thì tài quan tương sinh, kỵ tỷ kiếp đoạt tài.', application: 'Khi nguyệt lệnh là tài tinh.' },
  { source: '渊海子平', rule: 'Ấn cách: tháng lệnh ấn, thân được sinh; kỵ tài phá ấn; tốt khi có quan sát sinh ấn tạo quan ấn.', application: 'Khi nguyệt lệnh là ấn tinh.' },
  { source: '渊海子平', rule: 'Thực thương cách: tháng lệnh thực thương, thân vượng thì phát qua tài (thực thương sinh tài); kỵ quan tinh với thương quan cách.', application: 'Khi nguyệt lệnh là thực thần hoặc thương quan.' },
  { source: '渊海子平', rule: 'Đại vận đi theo chiều thuận hoặc nghịch theo âm dương niên can và giới tính: dương nam âm nữ thuận, âm nam dương nữ nghịch (pháp phổ biến kinh điển).', application: 'Khi xếp thứ tự đại vận 10 năm.' },
  { source: '渊海子平', rule: 'Đại vận mỗi bước 10 năm, khởi vận theo số ngày đến tiết trước/sau; vận đầu có thể không đủ 10 năm (khởi vận số).', application: 'Khi tính tuổi khởi đại vận và độ dài vận đầu.' },
  { source: '渊海子平', rule: 'Đại vận địa chi quan trọng hơn can: chi là gốc khí, can là dụng; xung hợp với nguyệt lệnh nhật chi quyết định biến động lớn.', application: 'Khi luận từng bước đại vận.' },
  { source: '渊海子平', rule: 'Đại vận sinh phù dụng thần, chế kỵ thần thì cát; đại vận làm vượng kỵ, khắc phá dụng thần thì hung.', application: 'Khi đánh giá tốt xấu từng đại vận.' },
  { source: '渊海子平', rule: 'Lưu niên như khách, đại vận như chủ: lưu niên phát lực trong khung đại vận; niên xung hợp với vận và mệnh tạo sự kiện cụ thể.', application: 'Khi luận năm cụ thể trong một đại vận.' },
  { source: '渊海子平', rule: 'Tứ trụ cân bằng ngũ hành là lý tưởng thô; thực tế ưu tiên dụng thần hữu lực hơn là đủ năm hành — thiếu hành không nhất thiết xấu nếu không phải dụng.', application: 'Khi người dùng lo thiếu hành — chỉnh lại theo dụng thần.' },
  { source: '渊海子平', rule: 'Can thiên là khí thanh, chi địa là khí trọc căn bản; luận lực phải xem can có căn trong chi (trường sinh, lộc, tuyệt…) hay không.', application: 'Khi đánh giá sức mạnh từng thập thần.' },
  { source: '渊海子平', rule: 'Hợp can (giáp kỷ, ất canh, bính tân, đinh nhâm, mậu quý) có thể hợp hóa hoặc hợp mà không hóa — cần tháng lệnh và toàn cục quyết định hóa thành.', application: 'Khi có cặp can hợp trong mệnh hoặc vận.' },
  { source: '渊海子平', rule: 'Xung chi (tý ngọ, sửu mùi, dần thân, mão dậu, thìn tuất, tỵ hợi) chủ biến động, ly tán, kích hoạt; xung cung nào động cung ấy.', application: 'Khi đại vận lưu niên xung các chi trong mệnh.' },
  { source: '子平真诠', rule: 'Kiến lộc cách (月令建禄): tháng lệnh lộc của nhật chủ, thân vượng — cần quan sát tài tinh làm dụng, kỵ thêm tỷ kiếp.', application: 'Khi nguyệt chi là lộc của nhật can.' },
  { source: '子平真诠', rule: 'Dương nhẫn cách: tháng lệnh dương nhẫn, thân cực vượng — cần quan sát chế nhẫn làm dụng; hữu chế thành uy, vô chế hung bạo.', application: 'Khi nguyệt lệnh là dương nhẫn nhật chủ.' },
  { source: '三命通会', rule: 'Quý nhân hợp với cung vị: quý nhân ở năm chủ cứu sớm/gốc; ở thời chủ cứu muộn; quý nhân bị xung thì lực giảm, khó phát huy.', application: 'Khi có quý nhân ở các trụ khác nhau.' },
  { source: '渊海子平', rule: 'Tam hợp cục (thân tý thìn thủy, hợi mão mùi mộc, dần ngọ tuất hỏa, tỵ dậu sửu kim) hội đủ thành cục mạnh; hội hai chữ là bán hợp, lực vừa.', application: 'Khi các chi mệnh vận tạo tam hợp hoặc bán hợp.' },
];

// ====================================================================
//  [QUALITY DEEP] 三式 systems — 96 rules distilled (奇门/六壬/太乙)
// ====================================================================
export const SANSHI_DEEP = [
{ system: '奇门', element: '开门', reading: 'Cửa mở — thuận lợi khởi sự, công danh, xuất hành, cầu tài. Dùng khi hỏi việc mới, xin việc, khai trương; vượng nhất ở cung sinh vượng, tránh khi gặp Bạch Hổ/Đại Hung.' },
  { system: '奇门', element: '休门', reading: 'Cửa nghỉ — tốt cầu an, chữa bệnh, hòa giải, nghỉ ngơi tích lũy. Dùng khi hỏi sức khỏe, hòa hợp gia đình; không dùng cho công danh gấp hay tranh chấp.' },
  { system: '奇门', element: '生门', reading: 'Cửa sinh — cực tốt cầu tài, sản xuất, nuôi dưỡng, sinh con. Ưu tiên khi hỏi kinh doanh, đầu tư dài hạn; kết hợp Cửu Thiên/Thiên Phụ càng mạnh.' },
  { system: '奇门', element: '伤门', reading: 'Cửa thương — hao tổn, tranh chấp, săn bắt, thi cử cạnh tranh. Có thể dùng chủ động khi cần tranh đấu/kiện tụng; tránh hỏi hôn nhân, hợp tác lâu dài.' },
  { system: '奇门', element: '杜门', reading: 'Cửa bế — ẩn náu, bí mật, công nghệ, trốn tránh. Tốt nghiên cứu, che giấu, an ninh mạng; xấu cho quảng bá, khai trương, cầu danh công khai.' },
  { system: '奇门', element: '景门', reading: 'Cửa cảnh — văn thư, thi cử, truyền thông, vẻ ngoài. Dùng hỏi học hành, giấy tờ, marketing; dễ hư danh nếu gặp Đằng Xà/Thiên Rui.' },
  { system: '奇门', element: '死门', reading: 'Cửa tử — kết thúc, tang sự, tuyệt địa, bất động sản cũ. Tránh hầu hết việc mới; có thể dùng khi hỏi dứt điểm, phá hủy, hoặc địa điểm âm trầm.' },
  { system: '奇门', element: '惊门', reading: 'Cửa kinh — lo sợ, kiện tụng, tin đồn, khẩu thiệt. Dùng khi hỏi tranh chấp pháp lý, lời nói; xấu hôn nhân/đối tác nếu chủ khách đều kinh.' },
  { system: '奇门', element: '门开闭规则', reading: 'Cửa mở khi cung vượng/tương sinh với Nhật thời và không bị hình xung khắc; đóng khi cung tù tử, gặp Không Vong hoặc hung thần áp. Ứng dụng: chỉ hành sự qua cung cửa mở + tinh thần tốt.' },
  { system: '奇门', element: '天蓬星', reading: 'Tham Lang — nước, trộm cắp, mưu trí, dục vọng, thủy lợi. Tốt mưu lược/ngầm; xấu chính danh, dễ dính thị phi dục vọng nếu gặp Bạch Hổ.' },
  { system: '奇门', element: '天芮星', reading: 'Cự Môn — bệnh, thầy thuốc, kiện tụng, ám muội. Tốt hỏi bệnh/y thuật; hung cho hôn nhân, xuất hành xa nếu không có kỳ cứu.' },
  { system: '奇门', element: '天冲星', reading: 'Lộc Tồn — xung kích, quyết đoán, quân sự, tốc độ. Tốt thi đấu, khởi binh, phá thế; xấu nhu hòa, thai sản, việc cần kiên nhẫn.' },
  { system: '奇门', element: '天辅星', reading: 'Văn Khúc — văn hóa, giáo dục, quý nhân, trợ giúp. Cực tốt học hành, xin chỉ thị, cầu sư; gặp Cảnh Môn càng đẹp cho thi cử.' },
  { system: '奇门', element: '天禽星', reading: 'Liêm Trinh trung — trung hòa, điều phối, trung tâm quyền lực. Ổn định cục, trung gian hòa giải; ít thiên lệch, dùng khi cần giữ thế trung lập.' },
  { system: '奇门', element: '天心星', reading: 'Vũ Khúc y — y dược, mưu kế, tâm ý, kỹ thuật tinh. Tốt chữa bệnh, thiết kế, tư vấn; gặp Đỗ Môn hợp việc bí mật chuyên môn.' },
  { system: '奇门', element: '天柱星', reading: 'Phá Quân — phá hủy, khẩu thiệt, đổ vỡ. Hung hôn nhân/hợp đồng; có thể dùng phá thế cũ, thanh lọc, sa thải dứt điểm.' },
  { system: '奇门', element: '天任星', reading: 'Tả Phụ — xây dựng, trách nhiệm, đất đai, trung hậu. Tốt bất động sản, tích lũy, chức vụ ổn; chậm nhưng bền, hợp Sinh Môn.' },
  { system: '奇门', element: '天英星', reading: 'Hữu Bật — lửa, huyết quang, danh tiếng nóng, tình cảm. Tốt quảng bá ngắn hạn; dễ nóng vội, tai nạn lửa máu nếu gặp Thương/Kinh.' },
  { system: '奇门', element: '值符', reading: 'Trực Phù — thần chủ lệnh, quý nhân tối cao của cục. Gặp Trực Phù = có thế, được che chở; dùng hỏi quyền lực, xin việc quan, định chủ việc.' },
  { system: '奇门', element: '腾蛇', reading: 'Đằng Xà — nghi hoặc, giả dối, kinh hãi, biến hóa. Cảnh báo lừa dối/giấy tờ ảo; tránh ký kết, kiểm tra kỹ tin tức và hợp đồng.' },
  { system: '奇门', element: '太阴', reading: 'Thái Âm — che giấu, âm mưu, phụ nữ, tài liệu mật. Tốt việc ngầm, kế hoạch chưa công bố; xấu phơi bày công khai, dễ dính thị phi nữ giới.' },
  { system: '奇门', element: '六合', reading: 'Lục Hợp — hòa hợp, môi giới, hôn nhân, giao dịch. Ưu tiên hỏi hợp tác, kết hôn, ký kết; gặp Khai/Sinh càng thuận.' },
  { system: '奇门', element: '白虎', reading: 'Bạch Hổ — sát khí, máu me, kiện tụng, cứng rắn. Hung thương tật, va chạm; chỉ dùng khi cần áp chế, cưỡng chế, quân sự.' },
  { system: '奇门', element: '玄武', reading: 'Huyền Vũ — trộm cắp, lừa đảo, tiểu nhân, thủy đạo. Cảnh báo mất mát/gian lận; tránh đầu tư mù quáng, kiểm soát dòng tiền.' },
  { system: '奇门', element: '九地', reading: 'Cửu Địa — ẩn náu, phòng thủ, chậm chắc, đất đai. Tốt phòng thủ, mai phục, bất động sản; xấu tốc chiến, marketing ồn ào.' },
  { system: '奇门', element: '九天', reading: 'Cửu Thiên — cao vút, xuất hành, thanh danh, tấn công. Tốt bay nhảy, thăng tiến, phát ngôn; gặp Khai Môn rất đẹp công danh.' },
  { system: '奇门', element: '三奇得使', reading: 'Tam Kỳ đắc sứ — Ất/Bính/Đinh ở đúng cung được dùng (sứ mã), phát huy lực cứu. Báo hiệu thời cơ quý nhân thực sự; dùng khi chốt việc lớn trong giờ đó.' },
  { system: '奇门', element: '三奇贵人', reading: 'Tam Kỳ quý nhân — Ất Bính Đinh hội tụ hoặc kỳ + Trực Phù/Lục Hợp. Rất tốt cầu cứu, thăng quan, hóa hung; ưu tiên hành động khi kỳ lâm cung dụng sự.' },
  { system: '奇门', element: '乙奇', reading: 'Ất kỳ — ngày (nhu hòa), che chở, nữ quý, văn thư. Tốt hòa giải, cầu hôn, xin giúp đỡ mềm; kém hiệu trong xung đột cứng.' },
  { system: '奇门', element: '丙奇', reading: 'Bính kỳ — mặt trời, uy quyền, chiếu sáng, phá tối. Tốt công khai chính nghĩa, thi cử, quan trường; mạnh khi gặp Khai/Cảnh.' },
  { system: '奇门', element: '丁奇', reading: 'Đinh kỳ — sao, văn kiện, kỹ thuật, điểm phá. Tốt hợp đồng, bằng cấp, thủ đoạn tinh; gặp Tâm/Phụ hợp chuyên môn cao.' },
  { system: '奇门', element: '天遁', reading: 'Thiên Độn — Bính kỳ + Trực Phù + Khai Môn (hoặc Cửu Thiên). Đại cát ẩn mình mà thành, xuất sư thuận; dùng xuất hành quan trọng, nhậm chức.' },
  { system: '奇门', element: '地遁', reading: 'Địa Độn — Ất kỳ + Cửu Địa + Sinh Môn. Cát ẩn náu sinh tài, phòng thủ có lời; dùng đầu tư đất, ẩn cư phát triển.' },
  { system: '奇门', element: '人遁', reading: 'Nhân Độn — Đinh kỳ + Thái Âm + Hưu Môn. Cát nhờ người/âm trợ, yên ổn; dùng cầu hòa, chữa bệnh, việc cần kín đáo.' },
  { system: '奇门', element: '神遁', reading: 'Thần Độn — Bính kỳ + Cửu Thiên + Sinh Môn. Cát thần tốc danh lợi, thanh thế; dùng ra mắt sản phẩm, cầu danh lớn.' },
  { system: '奇门', element: '鬼遁', reading: 'Quỷ Độn — Đinh kỳ + Cửu Địa + Đỗ Môn. Cát việc âm, huyền thuật, điều tra ngầm; không dùng chính danh công lộ.' },
  { system: '奇门', element: '风遁', reading: 'Phong Độn — Ất kỳ + Lục Hợp + Sinh Môn. Cát giao thiệp, môi giới, hợp tác sinh tài; dùng ký kết, mai mối, sales.' },
  { system: '奇门', element: '云遁', reading: 'Vân Độn — Ất kỳ + Thái Âm + Khai Môn. Cát che chở mà vẫn tiến, quan ẩn trợ; dùng xin việc, vận động ngầm.' },
  { system: '奇门', element: '龙遁', reading: 'Long Độn — Ất kỳ + Cửu Địa + Khai Môn (thủy cục). Cát thủy lợi, đi xa bằng thủy, tài từ phương thấp; dùng xuất hành thủy đạo.' },
  { system: '奇门', element: '虎遁', reading: 'Hổ Độn — Bính kỳ + Cửu Địa + Khai Môn. Cát uy mà vững, trấn áp; dùng nhậm chức nơi khó, thiết quân luật.' },
  { system: '奇门', element: '青龙返首', reading: 'Thanh Long phản thủ — Lục Nghi (mậu) gia Khai Môn ở cung sinh vượng. Đại cát cầu tài công danh quay đầu thuận; chốt deal lớn trong giờ này.' },
  { system: '奇门', element: '飞鸟跌穴', reading: 'Phi Điểu điệt huyệt — giá sử (thời can) lâm cung Trực Phù. Cát đắc vị, việc về đúng chỗ; dùng nhậm chức, về quê phát, chốt vị trí.' },
  { system: '奇门', element: '白虎猖狂', reading: 'Bạch Hổ xương cuồng — Canh gia Bạch Hổ hoặc Canh+Thương/Tử. Đại hung thương tật, đâm chém, phá sản bạo; tuyệt xuất hành mạo hiểm, phẫu thuật không cấp.' },
  { system: '奇门', element: '腾蛇妖娇', reading: 'Đằng Xà yêu kiều — Kỷ gia Đằng Xà, nghi hoặc mị hoặc. Hung lừa tình, hợp đồng ảo, tâm thần bất an; hoãn ký kết, soi xét đối tác.' },
  { system: '奇门', element: '朱雀投江', reading: 'Chu Tước đầu giang — Đinh bị khắc/hãm thủy nặng, văn thư thất. Hung giấy tờ mất, thi trượt, hỏa tai liên quan nước; tránh nộp hồ sơ gấp.' },
  { system: '奇门', element: '大格/刑格', reading: 'Đại Cách/Hình Cách — can xung hình với Nhật thời hoặc môn tinh xung khắc nặng. Báo trở ngại cứng, dễ hình sự khẩu thiệt; đổi giờ hoặc hoãn việc.' },
  { system: '六壬', element: '贵人', reading: 'Quý Nhân — tối tôn, quý trợ, quan phủ. Được che chở, gặp cấp trên; dùng hỏi công danh, xin việc, kiện tụng cần thế lực.' },
  { system: '六壬', element: '螣蛇', reading: 'Đằng Xà — kinh sợ, giả dối, biến ảo, mộng mị. Cảnh báo lừa gạt, tin đồn; xấu hôn nhân/ký kết, tốt điều tra gian tình.' },
  { system: '六壬', element: '朱雀', reading: 'Chu Tước — văn thư, khẩu thiệt, tin tức, huyết quang nhẹ. Tốt thi cử/giấy tờ; hung tranh cãi, kiện cáo lời nói.' },
  { system: '六壬', element: '六合', reading: 'Lục Hợp — hòa hợp, hôn nhân, môi giới, bí mật. Cực tốt kết hôn, hợp tác, mai mối; che giấu việc riêng.' },
  { system: '六壬', element: '勾陈', reading: 'Câu Trần — trì trệ, đất đai, kiện tụng dai dẳng, trói buộc. Hung dây dưa; dùng hỏi bất động sản, tranh chấp lâu năm.' },
  { system: '六壬', element: '青龙', reading: 'Thanh Long — tài lộc, vui vẻ, rượu thịt, quý khí. Tốt cầu tài, ăn uống, hỷ sự; tránh phóng đãng nếu quá vượng.' },
  { system: '六壬', element: '天空', reading: 'Thiên Không — hư không, lừa dối, tăng đạo, lời hứa suông. Cảnh báo không có thực; tránh đầu tư, đòi nợ khó thu.' },
  { system: '六壬', element: '白虎', reading: 'Bạch Hổ — tang thương, binh đao, bệnh nặng, đường sá. Hung tai nạn/phẫu thuật; mạnh khi cần uy, cưỡng chế.' },
  { system: '六壬', element: '太常', reading: 'Thái Thường — y phục, rượu lễ, ổn định, nông sản. Tốt hôn lễ, bổng lộc thường; hơi chậm, hợp việc chính thống.' },
  { system: '六壬', element: '玄武', reading: 'Huyền Vũ — trộm cắp, gian dâm, lừa đảo, tiểu nhân. Cảnh báo mất của/ngoại tình; kiểm soát bảo mật và trung thành.' },
  { system: '六壬', element: '太阴', reading: 'Thái Âm — che đậy, nữ quý, kế hoạch kín, tài liệu. Tốt mưu sự ban đêm, nhờ nữ trợ; xấu phơi bày công khai.' },
  { system: '六壬', element: '天后', reading: 'Thiên Hậu — phụ nữ, che chở, dâm thích, âm thấp. Tốt nhờ nữ quý/mẹ vợ; thận trọng sắc dục, việc thủy đạo.' },
  { system: '六壬', element: '四课', reading: 'Tứ khóa — nhật dương, nhật âm, thần dương, thần âm. Nền tảng xem quan hệ chủ-khách-sự; dùng xác định ai chủ động, xung đột ở đâu.' },
  { system: '六壬', element: '三传', reading: 'Tam truyền — sơ, trung, mạt truyền. Diễn biến đầu-giữa-cuối việc; đọc tuần tự để biết khởi, biến, kết.' },
  { system: '六壬', element: '元首课', reading: 'Nguyên Thủ — thượng khắc hạ, một khóa làm đầu. Việc do cấp trên/chủ động áp xuống, nhanh gọn; dùng khi hỏi quan hệ trên dưới, quyết định từ trên.' },
  { system: '六壬', element: '重审课', reading: 'Trọng Thẩm — hạ tặc thượng, âm mưu dưới lật. Việc từ dưới phản, cần xem xét lại; dùng kiện tụng, nội bộ phản kháng.' },
  { system: '六壬', element: '知一课', reading: 'Tri Nhất — hai thượng khắc hạ, lấy涉害/ưu tiên. Tình thế phân vân hai hướng; chọn phía ít hại hơn, tránh ôm đồm.' },
  { system: '六壬', element: '涉害课', reading: 'Thiệp Hại — nhiều khắc, lấy sâu hại nhất. Việc gian nan, phải chịu tổn hao mới xong; dùng khi biết trước sẽ vất vả.' },
  { system: '六壬', element: '遥克课', reading: 'Dao Khắc — không tương khắc gần, lấy khắc xa. Ảnh hưởng gián tiếp, người ngoài tác động; dùng hỏi thị phi từ xa, tin đồn.' },
  { system: '六壬', element: '昴星课', reading: 'Mão Tinh — không khắc, lấy Mão/Dậu làm truyền. Việc trắc trở, nửa vời, hay hư; thận trọng lời hứa và lộ trình.' },
  { system: '六壬', element: '别责课', reading: 'Biệt Trách — không tương khắc chuẩn, lấy hợp làm truyền. Việc lệch chuẩn, trách nhiệm ngoài lề; dùng khi hỏi việc không chính danh.' },
  { system: '六壬', element: '八专课', reading: 'Bát Chuyên — nhật thần đồng cung loại. Việc tập trung một mối, chuyên sâu; tốt chuyên môn, xấu hẹp hòi cố chấp.' },
  { system: '六壬', element: '伏吟课', reading: 'Phục Ngâm — truyền trùng vị, ẩn nín. Việc trì trệ, tâm sự không nói, lặp lại; hoãn xuất hành, chú ý bệnh tái.' },
  { system: '六壬', element: '返吟课', reading: 'Phản Ngâm — xung vị truyền, đi rồi về. Việc đảo chiều, phản phúc, đi xa lại hoàn; dùng hỏi phản bội, đổi ý đột ngột.' },
  { system: '六壬', element: '炎上课', reading: 'Viêm Thượng — ba truyền hỏa cục. Nóng vội, danh tiếng, kiện cáo sôi; tốt quảng bá ngắn, xấu nóng giận tai lửa.' },
  { system: '六壬', element: '润下课', reading: 'Nhuận Hạ — ba truyền thủy cục. Lưu động, tài từ xa, tình cảm; tốt đi thủy/buôn chuyển, xấu dâm đãng trôi nổi.' },
  { system: '六壬', element: '从革课', reading: 'Tòng Cách — ba truyền kim cục. Cứng rắn, binh đao, cải cách; tốt kỷ luật/kim loại, hung thương tổn tranh chấp.' },
  { system: '六壬', element: '稼穑课', reading: 'Giá Sắc — ba truyền thổ cục. Chậm chắc, đất đai, nông sản; tốt bất động sản tích lũy, xấu trì trệ kiện tụng đất.' },
  { system: '六壬', element: '曲直课', reading: 'Khúc Trực — ba truyền mộc cục. Sinh sôi, văn hóa, điều chỉnh; tốt trồng trọt/giáo dục, dễ ngang ngạnh khó thu.' },
  { system: '六壬', element: '龙加贵人', reading: 'Thanh Long + Quý Nhân — tài lộc có quý trợ. Cực tốt thăng quan phát tài chính đáng; chốt xin việc, đầu tư có backing.' },
  { system: '六壬', element: '虎加朱雀', reading: 'Bạch Hổ + Chu Tước — miệng lưỡi hóa đao. Hung kiện cáo, tai nạn giao thông lời lẽ; tránh tranh cãi công khai.' },
  { system: '六壬', element: '玄加天后', reading: 'Huyền Vũ + Thiên Hậu — sắc dục gian lận. Cảnh báo ngoại tình, lừa tình tiền; soi xét quan hệ nam nữ và tiền bạc chung.' },
  { system: '六壬', element: '合加太常', reading: 'Lục Hợp + Thái Thường — hôn lễ hòa hợp. Rất tốt cưới hỏi, tiệc tùng chính thống; dùng chọn ngày lễ, ký kết vui.' },
  { system: '六壬', element: '蛇加勾陈', reading: 'Đằng Xà + Câu Trần — nghi hoặc dây dưa. Hung kiện tụng rối, tâm thần mệt; không nên khởi kiện vội, thu thập chứng rõ.' },
  { system: '六壬', element: '空加白虎', reading: 'Thiên Không + Bạch Hổ — hư họa, dọa ma. Hung tin xấu không thật hoặc mất trắng; xác minh tin tai nạn trước khi hành động.' },
  { system: '太乙', element: '太乙贵神', reading: 'Thái Ất quý thần — trung tâm vận quốc/đại cục. Vị trí Thái Ất chỉ phương thế mạnh của năm; dùng xem quốc vận, doanh nghiệp lớn, dòng chảy quyền lực.' },
  { system: '太乙', element: '文昌', reading: 'Văn Xương — văn thư, mưu sĩ, thi cử quốc gia. Ảnh hưởng chính sách, giáo dục, truyền thông; dùng xem năm cải cách luật/học thuật.' },
  { system: '太乙', element: '始击', reading: 'Thủy Kích — điểm xung đột khởi phát. Phương/thời Thủy Kích là nơi sự cố bùng; dùng cảnh báo khủng hoảng, chiến sự, cạnh tranh mở.' },
  { system: '太乙', element: '主客算', reading: 'Chủ khách toán — so sánh lực chủ-khách. Chủ thắng thì giữ, khách thắng thì công; dùng chiến lược công thủ năm/quý, đàm phán lớn.' },
  { system: '太乙', element: '定目', reading: 'Định Mục — tiêu điểm sự kiện năm. Chỉ hướng việc trọng tâm sẽ tụ; dùng lập kế hoạch năm, chọn thị trường trọng điểm.' },
  { system: '太乙', element: '计神', reading: 'Kế Thần — mưu kế, tham mưu, tài chính ngầm. Tốt năm dùng trí hơn lực; dùng chiến lược, phòng gián điệp kinh tế.' },
  { system: '太乙', element: '合神', reading: 'Hợp Thần — hòa hợp liên minh. Năm dễ kết minh, sáp nhập; dùng M&A, ngoại giao, liên doanh.' },
  { system: '太乙', element: '掩/击/格/迫', reading: 'Yểm/Kích/Cách/Bách — bốn thế giam hãm Thái Ất. Báo quốc nạn, lãnh đạo bị ép, chính sách kẹt; dùng cảnh báo năm khó cải cách mạnh.' },
  { system: '太乙', element: '岁计', reading: 'Tuế kế — toán số cả năm. Tổng lực cát hung năm; dùng dự báo vĩ mô GDP tinh thần xã hội, lập ngân sách thận trọng.' },
  { system: '太乙', element: '月计', reading: 'Nguyệt kế — sóng tháng trong năm. Chọn tháng hành động lớn; dùng lên lịch IPO, bầu cử nội bộ, ra mắt chiến dịch.' },
  { system: '太乙', element: '日计/时计', reading: 'Nhật/Thời kế — chốt giờ sự kiện cực trọng. Chỉ dùng đại sự quốc gia/tập đoàn; tinh chỉnh giờ ký, tuyên bố, khai trương cấp nhà nước.' },
  { system: '太乙', element: '十六神将方位', reading: 'Thập lục thần tướng phương vị — phân bố lực 16 thần. Đọc địa bàn sức mạnh vùng miền; dùng mở rộng địa lý, phân bổ nguồn lực theo phương.' },
  { system: '太乙', element: '阳遁阴遁局', reading: 'Dương độn/Âm độn cục — đông chí–hạ chí phân dương âm. Dương cục thuận công, âm cục thuận thủ; căn cứ nửa năm để chọn chiến lược tổng.' },
  { system: '太乙', element: '太乙入中宫', reading: 'Thái Ất nhập trung cung — vận hội tụ trung tâm. Dễ tập quyền, cũng dễ bế tắc trung ương; dùng xem năm trung ương mạnh hay kẹt.' },
  { system: '太乙', element: '流年国运总断', reading: 'Tổng đoán lưu niên quốc vận — ghép Thái Ất + Thủy Kích + Chủ Khách + Yểm Kích. Khung chuẩn app: thế–xung đột–ai thắng–có bị khóa; xuất báo cáo năm ngắn gọn cho lãnh đạo.' },
];


// ====================================================================
//  [SCHOLARLY] 10 kinh quan trọng — DỊCH FULL tiếng Việt (độc quyền)
// ====================================================================
export const KEY_KINH_FULL_VN = [
{ title_han: '阴符经', title_vi: 'Âm Phù Kinh', context: 'Kinh điển nền tảng triết học Đạo gia về quan hệ trời–đất–người và ngũ hành. Khái niệm “đạo cơ” (cơ cướp lấy khí của trời đất) là gốc lý luận BaZi: vận mệnh là tương tác động giữa thiên thời, địa lợi và nhân sự.', full: 'Quán sát đạo của Trời, nắm giữ sự vận hành của Trời, thì mọi việc đều trọn vẹn. Trời có năm tặc, ai thấy được thì hưng thịnh. Năm tặc ở trong tâm, thi hành theo Trời. Vũ trụ nằm trong bàn tay, vạn hóa sinh ra từ thân. Tính Trời chính là người; lòng người chính là cơ. Lập đạo Trời để định con người. Trời phát sát cơ thì dời sao đổi tú; đất phát sát cơ thì rồng rắn nổi khỏi đất; người phát sát cơ thì trời đất đảo lộn; trời người cùng phát thì muôn biến định nền. Tánh có khéo vụng, có thể ẩn giấu. Tà của chín khiếu nằm ở ba chỗ then chốt, có thể động tĩnh. Lửa sinh từ gỗ, họa phát ắt khắc; gian sinh trong nước, thời động ắt tan; biết mà tu luyện, gọi là thánh nhân. Trời sinh trời giết, đó là lý của đạo.  Trời đất là kẻ cướp của vạn vật; vạn vật là kẻ cướp của người; người là kẻ cướp của vạn vật. Ba mối cướp đã đúng chỗ thì ba tài đã an. Cho nên nói: Ăn đúng thời thì trăm khớp xương thuận lý; động đúng cơ thì vạn hóa an định. Người biết thần của mình mà thần, không biết chỗ không-thần mà nhờ đó thành thần. Nhật nguyệt có số, lớn nhỏ có định. Công thánh sinh ra từ đó, thần minh hiện ra từ đó. Cơ cướp ấy, thiên hạ không ai thấy, không ai biết. Người quân tử được thì vững thân; kẻ tiểu nhân được thì coi nhẹ mạng.  Kẻ mù thì nghe tinh, kẻ điếc thì nhìn tinh. Dứt một nguồn lợi, dùng sức gấp mười; ba lần xoay ngày đêm, dùng sức gấp vạn. Tâm sinh vì vật, chết vì vật; cơ nằm ở mắt. Trời không ân riêng mà ân lớn sinh. Sấm nhanh gió dữ, không gì không kinh động. Vui tột thì tánh dư, tĩnh tột thì tánh liêm. Trời cực tư mà dùng cực công. Chế ngự cầm thú nằm ở khí. Sinh là gốc của tử, tử là gốc của sinh. Ân sinh từ hại, hại sinh từ ân. Kẻ ngu lấy văn lý trời đất làm thánh; ta lấy văn lý thời vật làm trí. Người lấy ngu dò thánh; ta lấy không ngu làm thánh. Người lấy kỳ lạ mong thánh; ta lấy không kỳ lạ mong thánh. Cho nên nhận chìm trong nước, lao vào lửa, tự chuốc diệt vong. Đạo tự nhiên vốn tĩnh, nên trời đất vạn vật sinh. Đạo trời đất thấm dần, nên âm dương thắng. Âm dương đẩy nhau mà biến hóa thuận. Vì vậy thánh nhân biết đạo tự nhiên không thể trái, nhân đó mà chế ngự nó. Đạo tĩnh tột, luật lịch không khế hợp được. Bèn có kỳ khí, sinh ra muôn tượng. Bát quái giáp tý, thần cơ quỷ tàng. Thuật âm dương thắng nhau, rành rành tiến vào trong tượng.' },
  { title_han: '心印经', title_vi: 'Tâm Ấn Kinh', context: 'Kinh ngắn cô đọng tinh hoa nội đan Đạo giáo: thượng dược tam phẩm (thần–khí–tinh), hỏa hầu và chứng nghiệm. Là chìa khóa hiểu “tu luyện nội tại” song hành với đọc mệnh BaZi.', full: 'Thuốc thượng đẳng có ba phẩm: thần cùng khí tinh. Mờ mịt khó lường, xa xăm thẳm thẳm. Giữ cái không, thủ cái có, trong chốc lát đã thành. Gió quay hòa hợp, trăm ngày công linh. Lặng lẽ chầu Thượng Đế, một kỷ bay lên. Người biết thì dễ ngộ, kẻ tối thì khó làm. Bước theo ánh trời, hô hấp nuôi thanh. Ra huyền vào tẫn, như mất như còn. Miên man không dứt, gốc rễ vững sâu. Người ai cũng có tinh; tinh hợp với thần. Thần hợp với khí; khí hợp với chân. Không được cái chân, đều chỉ là tên gượng. Thần có thể vào đá, thần có thể bay hình. Vào nước không chìm, vào lửa không cháy. Thần nương hình mà sinh, tinh nương khí mà đầy. Không tàn không héo, như tùng bách xanh tươi. Ba phẩm một lý, diệu không thể nghe. Tụ thì có, tán thì tan. Bảy khiếu thông nhau, khiếu khiếu sáng lòa. Nhật thánh nguyệt thánh, chiếu rọi sân vàng. Được một lần là được mãi, thân tự nhiên nhẹ. Thái hòa tràn đầy, xương tan như ngọc lạnh. Được đan thì linh, không được thì nghiêng. Đan ở trong thân, chẳng trắng chẳng xanh. Tụng đến vạn biến, diệu lý tự sáng.' },
  { title_han: '清静经', title_vi: 'Thanh Tĩnh Kinh', context: 'Kinh cốt lõi về thanh tĩnh vô vi — gốc của tu dưỡng tâm tính Đạo gia. Trong BaZi và mệnh lý, “tĩnh” là nền để quan sát khí số, “thanh” là để không bị dục vọng làm lệch phán đoán.', full: 'Lão quân nói: Đại đạo không hình, sinh nuôi trời đất; đại đạo không tình, vận hành mặt trời mặt trăng; đại đạo không tên, nuôi lớn muôn vật; ta không biết tên nó, gượng gọi là Đạo. Đạo có trong đục, có động tĩnh; trời trong đất đục, trời động đất tĩnh; nam trong nữ đục, nam động nữ tĩnh. Từ gốc chảy ra ngọn, mà sinh muôn vật. Trong là nguồn của đục, động là nền của tĩnh. Người biết thường giữ thanh tĩnh thì trời đất đều về với mình.  Thần con người thích trong mà tâm làm rối; tâm con người thích tĩnh mà dục kéo đi. Thường biết dẹp dục thì tâm tự tĩnh; lắng tâm thì thần tự trong. Tự nhiên sáu dục không sinh, ba độc tiêu diệt. Sở dĩ không làm được, vì tâm chưa lắng, dục chưa dẹp. Kẻ biết dẹp được: nhìn trong thì tâm không còn tâm; nhìn ngoài thì hình không còn hình; nhìn xa thì vật không còn vật. Ba thứ đã ngộ, chỉ thấy không. Nhìn không cũng không, không không còn chỗ không; chỗ không đã hết thì “không không” cũng không; “không không” đã không thì trong lặng thường tịch; tịch không còn chỗ tịch, dục há còn sinh? Dục đã không sinh tức là chân tĩnh. Chân thường ứng vật, chân thường được tánh; thường ứng thường tĩnh, thường thanh tĩnh vậy. Thanh tĩnh như thế, dần vào chân đạo; đã vào chân đạo, gọi là được đạo; tuy gọi là được đạo, thật không có gì để được; vì hóa độ chúng sinh nên gọi là được đạo; ai ngộ được, khá truyền thánh đạo.  Lão quân nói: Bậc thượng sĩ không tranh, kẻ hạ sĩ ưa tranh; bậc thượng đức không chấp đức, kẻ hạ đức bám lấy đức; còn chấp trước thì không gọi là đạo đức. Chúng sinh sở dĩ không được chân đạo, vì có vọng tâm. Đã có vọng tâm thì kinh động thần; thần đã kinh thì dính mắc muôn vật; dính mắc muôn vật thì sinh tham cầu; tham cầu thì có phiền não; phiền não vọng tưởng làm ưu khổ thân tâm; bèn gặp nhơ đục, lưu lạc sinh tử, chìm mãi biển khổ, vĩnh viễn mất chân đạo. Đạo chân thường, người ngộ tự được. Người đã được ngộ đạo, thường thanh tĩnh vậy.' },
  { title_han: '玉枢经', title_vi: 'Ngọc Khu Kinh', context: 'Kinh quan trọng của phái Lôi pháp, nhấn mạnh giải ách tiêu tai bằng tâm thành và trì tụng. Thường dùng trong nghi thức cầu an, hóa giải hạn xấu — liên hệ trực tiếp với thực hành BaZi khi gặp đại hạn hung.', full: 'Thiên tôn nói: Đạo lấy thành mà vào, lấy lặng mà giữ, lấy mềm mà dùng. Dùng thành giống như ngu, dùng lặng giống như ngọng, dùng mềm giống như vụng. Như thế thì có thể quên hình, quên ta, quên cả sự quên. Người vào đạo biết dừng, người giữ đạo biết cẩn, người dùng đạo biết vi. Biết vi thì tuệ quang sinh; biết cẩn thì thánh trí trọn; biết dừng thì thái định an. Thái định an thì thánh trí trọn; thánh trí trọn thì tuệ quang sinh; tuệ quang sinh thì cùng đạo làm một, gọi là chân vong. Chỉ vì quên mà không quên, quên đến không còn gì để quên; cái không còn gì để quên chính là chí đạo.  Thiên tôn nói: Nếu đời sau có chúng sinh được nghe tên ta, chỉ cần lặng tâm mặc tưởng, xưng “Cửu Thiên Ứng Nguyên Lôi Thanh Phổ Hóa Thiên Tôn” — hoặc một tiếng, hoặc năm bảy tiếng, hoặc ngàn trăm tiếng — ta liền hóa hình mười phương, vận tâm ba cõi, khiến kẻ xưng danh đều được như ý.  Thiên tôn nói: Nếu có người ngũ hành kỳ gian nan, chín diệu trắc trở, năm gặp hình xung, vận gặp khắc chiến, cô thìn quả tú, dương nhẫn kiếm phong, kiếp sát vong thần, quỷ môn câu giảo, lộc bị phá bại, mã rơi không vong, động dụng hung nguy, hành tàng gian nan — liền tụng kinh này. Trên thỉnh thiên quan giải thiên ách, địa quan giải địa ách, thủy quan giải thủy ách, ngũ đế giải ngũ phương ách, tứ thánh giải tứ thời ách, nam thần giải bản mệnh ách, bắc đẩu giải hết thảy ách.  Thiên tôn nói: Bệnh trầm nằm gối, cố tật đè thân, lâu ngày không khỏi, cầu y không hiệu, năm thần không chủ, tứ đại không thu; hoặc do oan khiên trước ngũ đế tam quan, trước Thái Sơn ngũ đạo, trước nhật nguyệt tinh thần, trước sơn lâm thảo mộc, trước linh đàn cổ tích, trước thành hoàng xã miếu, trước lý hạng giếng bếp, trước tự quán tháp lầu; hoặc địa phủ ba mươi sáu ngục, minh quan bảy mươi hai ty có oan khuất khiến vướng víu; hoặc do thề nguyền chú rủa chiêu cảm, hoặc do nợ nần đền bồi; ba đời kết oán, nhiều kiếp gây thù — đều nên thú tội sám hối, liền tụng kinh này.  Thiên tôn nói: Thiên quan phù, địa quan phù; năm tháng ngày giờ đều có quan phù; phương hướng quay lưng đều có quan phù. Lớn thì quan phù, nhỏ thì khẩu thiệt; có thần xích khẩu bạch thiệt chủ trì. Phàm động tĩnh khởi sự, ra vào cư xử, không biết tránh kỵ; nếu gặp quan phù khẩu thiệt thì bị quấy nhiễu ngày đêm, nhiều lời môi mép, mặt phải lưng trái, động là cãi vã, thề thần rủa Phật, khởi từ phỉ báng, kết bằng sỉ nhục; từ đó kiện tụng sinh, hình hiến hiện. Muốn thoát, liền tụng kinh này, ắt khẩu thiệt ngầm tiêu, quan phù vĩnh dứt.  Thiên tôn nói: Công đức kinh này không thể nghĩ bàn. Nhà nào có kinh này, chí thành an phụng, ắt được tường yên đầy sân, khánh vân che hiên, họa loạn không nảy, cát phúc tụ về; khi mất không qua địa ngục. Ra vào cư xử, đeo mang kinh này, người người kính, quỷ thần sợ. Gặp các hiểm nạn, nhất tâm xưng danh “Cửu Thiên Ứng Nguyên Lôi Thanh Phổ Hóa Thiên Tôn”, đều được giải thoát.' },
  { title_han: '太上感应篇', title_vi: 'Thái Thượng Cảm Ứng Thiên', context: 'Kinh điển đạo đức Đạo giáo ảnh hưởng sâu tới dân gian Trung Hoa và Việt Nam. Câu “họa phúc vô môn, duy nhân tự triệu” là nền tảng nhân quả trong mệnh lý: lá số mở cửa, hành vi con người quyết định họa phúc thực tế.', full: 'Thái Thượng nói: Họa phúc không có cửa, chỉ do người tự kêu gọi đến; báo ứng của thiện ác như bóng theo hình.  Vì vậy trong trời đất có thần ghi chép tội lỗi; tùy người phạm nặng nhẹ mà đoạt toán (tuổi thọ). Toán giảm thì nghèo hao, nhiều nỗi ưu khổ; người đều ghét; hình họa theo đuổi; cát khánh tránh xa; sao xấu giáng ương; toán hết thì chết.  Lại có thần quân Tam Thai, Bắc Đẩu ở trên đầu người, ghi tội đoạt kỷ toán. Lại có Tam Thi thần trong thân người, mỗi đến ngày canh thân lên chầu thiên tào, tâu tội lỗi. Ngày cuối tháng, Táo thần cũng vậy. Phàm người có lỗi, lớn thì đoạt kỷ, nhỏ thì đoạt toán. Các lỗi lớn nhỏ có đến hàng trăm việc; muốn cầu trường sinh trước phải tránh.  Hợp đạo thì tiến, trái đạo thì lùi. Không đi đường tà, không dối nơi tối; tích đức lũy công, đem lòng từ với muôn vật; trung hiếu hữu đễ, chính mình để hóa người; thương cô xót quả, kính già ấp ủ trẻ; côn trùng cây cỏ cũng không được hại. Nên thương nỗi hung của người, vui điều thiện của người; cứu cấp nạn của người, cứu nguy của người. Thấy được của người như được của mình; thấy mất của người như mất của mình. Không vạch chỗ ngắn của người, không khoe chỗ dài của mình; ngăn ác nêu thiện, đẩy nhiều lấy ít. Chịu nhục không oán, chịu sủng như kinh. Thi ân không cầu báo, cho người không hối tiếc.  Đó gọi là người thiện: người đều kính, thiên đạo phù, phúc lộc theo, chúng tà xa, thần linh hộ; việc làm ắt thành, tiên đạo có thể mong. Muốn cầu thiên tiên nên lập một ngàn ba trăm thiện; muốn cầu địa tiên nên lập ba trăm thiện.' },
  { title_han: '入药镜', title_vi: 'Nhập Dược Kính', context: 'Phú đan của Thôi Hi Phạm (đời Đường), được coi là “gương soi” để vào lò nội đan. Nói rõ tiên thiên khí, hỏa hầu, và chứng nghiệm — nền tảng cho hiểu mệnh khí và tu dưỡng.', full: 'Khí tiên thiên, khí hậu thiên; ai được nó, thường như say. Ngày có hợp, tháng có hợp; cùng đến Mậu Kỷ, định Canh Giáp. Cầu hạc trên, cầu hạc dưới; trời ứng sao, đất ứng triều. Khởi gió Tốn, vận lửa Khôn; vào hoàng phòng, thành chí bảo. Nước sợ khô, lửa sợ lạnh; lệch một mảy, không thành đan. Rồng chì thăng, hổ thủy giáng; sai khiến hai vật, chớ buông thả. Sinh ở Khôn, gieo ở Càn; chỉ chí thành, pháp tự nhiên. Cướp trời đất, đoạt tạo hóa; gom ngũ hành, họp bát quái. Nước là chân thủy, lửa là chân hỏa; thủy hỏa giao, mãi không già. Nước biết chảy, lửa biết bốc; ở trong thân, tự có thể nghiệm. Đó là tính mệnh, chẳng phải thần khí; chì ở hương nước, chỉ một vị. Về khiếu gốc, cửa phục mệnh; xuyên vĩ lư, thông nê hoàn. Bễ thổi chân, đỉnh lò chân; trong không có có, trong có có không. Nhờ hoàng bà, mai dắt nữ; nhẹ nhẹ thôi, lặng lặng nâng. Trong một ngày, mười hai thì; ý đến đâu, đều có thể làm. Uống đao khuê, dòm xảo trời; biện sóc vọng, biết tối sáng. Biết nổi chìm, rõ chủ khách; muốn hội tụ, chớ cách quãng. Lúc hái dược, điều hỏa công; nhận khí cát, phòng thành hung. Hỏa hầu đủ, chớ hại đan; trời đất linh, tạo hóa keo. Mới kết thai, xem bản mệnh; cuối thoát thai, xem tứ chính. Lặng lặng hành, câu câu ứng.' },
  { title_han: '坐忘论', title_vi: 'Tọa Vong Luận', context: 'Tác phẩm then chốt của Tư Mã Thừa Trinh (đời Đường) về phương pháp tu: bảy bậc từ kính tín đến đắc đạo. Chương “Thu tâm” là cốt lõi tĩnh tọa thực hành, bổ sung cho lý thuyết mệnh số.', full: 'Tâm là chủ của một thân, thầy của trăm thần; tĩnh thì sinh tuệ, động thì thành hôn. Mê say trong cảnh ảo mà chỉ nói là thật; vui nằm trong hữu vi, ai ngộ được hư phi? Tâm thức điên dại, thật do chỗ nương. Huống chi thân lìa cảnh sinh tử, tâm ở trong chí đạo — há không bỏ kia mà được đây sao?  Cho nên lúc mới học đạo, cần phải an tọa, thu tâm lìa cảnh, trụ vào chỗ không có gì, không dính một vật, tự vào hư vô, tâm mới hợp đạo. Kinh nói: “Trong chí đạo, tịch không có gì.” Thần dụng không có phương cố định, thể của tâm cũng vậy; nguồn thể của tâm lấy đạo làm gốc. Chỉ vì tâm thần bị nhuộm, che mờ ngày sâu, trôi dạt ngày lâu, bèn cách với đạo. Nay nếu biết tịnh trừ bụi tâm, mở tháo gốc thần, gọi là “tu đạo”. Không còn trôi dạt, ngầm hợp với đạo, an ở trong đạo, gọi là “quy căn”. Giữ gốc không rời, gọi là “tĩnh định”. Tĩnh định lâu ngày, bệnh tiêu mệnh phục; phục rồi lại nối, tự biết được thường. Biết thì không gì không sáng; thường thì vĩnh không biến diệt. Ra khỏi sinh tử, thật do đây.  Cho nên bắt chước đạo để an tâm, quý ở chỗ không dính mắc. Nếu chấp tâm trụ không, vẫn còn “có chỗ”, chưa phải “không chỗ”. Phàm trụ vào có chỗ thì khiến tâm mệt khí phát, đã không hợp lý, lại thành bệnh. Chỉ cần tâm không dính vật, lại được không động — đó là nền chân định. Dùng đó làm định, tâm khí hòa điều, lâu càng nhẹ sảng. Lấy đó làm nghiệm thì tà chính biết được.  Nay thì dứt loạn mà không diệt soi, giữ tĩnh mà không chấp không; hành có thường, tự được chân kiến. Nếu có việc thời hoặc pháp còn nghi, tạm cho suy lường; việc xong nghi ngộ, đó cũng là gốc sinh tuệ chính. Việc xong thì thôi, thật chớ đa tư; đa tư thì lấy tri hại điềm, vì con mà thương gốc. Nếu phiền tà loạn tưởng, vừa giác thì trừ; nếu nghe danh hủy dự, việc thiện ác, đều gạt bỏ ngay, chớ để tâm nhận; tâm nhận thì tâm đầy, tâm đầy thì đạo không chỗ ở. Mọi điều nghe thấy như không nghe thấy, thì thị phi mỹ ác không vào tâm. Tâm không nhận ngoài gọi là “hư tâm”; tâm không đuổi ngoài gọi là “an tâm”. Tâm an mà hư thì đạo tự đến ở. Kinh nói: “Người hay hư tâm vô vi, không cầu ở đạo mà đạo tự về.”  Bên trong đã không dính, bên ngoài cũng không làm; chẳng tịnh chẳng uế nên hủy dự không từ đâu sinh; chẳng trí chẳng ngu nên lợi hại không do đâu đến. Thật thì thuận trung làm thường, quyền thì tùy thời tiêu tức; tránh được các lụy, đó là trí vậy. Cho nên then chốt tu đạo, gấp ở trừ bệnh; bệnh không trừ, trọn không được định. Ruộng tốt mà gai chưa diệt, dù gieo giống cũng không thành mạ tốt. Ái kiến tư lự là gai của tâm; không cắt bỏ, định tuệ không sinh.  Thu tâm: tùy khởi tùy chế, cốt cho bất động; lâu ngày thuần thục, tự được an nhàn. Không hỏi ngày đêm, đi đứng ngồi nằm, và lúc ứng sự, thường phải cố ý an nó. Nếu tâm được định, chỉ cần an dưỡng, chớ não xúc; hơi được phần định đã đủ tự vui; dần dà thuần thục, chỉ thấy thanh viễn. Kinh nói: “Dù có ngọc bích để trước tứ mã, chẳng bằng ngồi tiến đạo này.” Pháp diệu ở chỗ hay làm, không ở hay nói.' },
  { title_han: '金光神咒', title_vi: 'Kim Quang Thần Chú', context: 'Thần chú hộ thân quan trọng trong Đạo giáo (một trong Bát đại thần chú / dùng khi khai đàn). Dùng để kết kim quang hộ thể, trấn tà — biểu tượng “chính khí bảo mệnh” trong thực hành tâm linh kèm xem hạn.', full: 'Trời đất huyền tông, Vạn khí gốc căn. Tu rộng ức kiếp, Chứng ngộ thần thông. Trong ngoài ba cõi, Chỉ đạo độc tôn. Thân có kim quang, Che chiếu thân ta. Nhìn không thấy hình, Nghe không ra tiếng. Bao trùm trời đất, Nuôi dưỡng quần sinh. Thụ trì vạn biến, Thân có ánh sáng. Ba cõi hầu vệ, Năm đế đón nghênh. Vạn thần triều lễ, Sai khiến lôi đình. Quỷ yêu mất mật, Tinh quái tan hình. Trong có sấm sét, Lôi thần ẩn danh. Tuệ động thông triệt, Năm khí thăng đằng. Kim quang mau hiện, Che phủ chân nhân. Gấp gấp như luật lệnh!' },
  { title_han: '净心神咒', title_vi: 'Tịnh Tâm Thần Chú', context: 'Một trong Bát đại thần chú Đạo giáo, dùng tịnh hóa tâm ý trước khi trì kinh, hành lễ hoặc luận mệnh. “Tịnh tâm” là điều kiện để cảm ứng và để đọc khí số không bị vọng niệm che.', full: 'Thái Thượng đài tinh, Ứng biến không ngừng. Đuổi tà trói mị, Giữ mệnh hộ thân. Trí tuệ sáng sạch, Tâm thần yên ổn. Ba hồn bền mãi, Phách không nghiêng lệch.' },
  { title_han: '净口神咒', title_vi: 'Tịnh Khẩu Thần Chú', context: 'Một trong Bát đại thần chú, tịnh hóa khẩu nghiệp trước khi tụng kinh, khấn nguyện. Trong truyền thống Đạo giáo và thực hành kèm BaZi, miệng sạch — lời thành — cảm ứng mới linh.', full: 'Thần miệng Đan Chu, Nhả uế trừ khí. Thần lưỡi Chính Luân, Thông mệnh nuôi thần. Thần răng La Thiên, Trừ tà hộ chân. Thần họng Hổ Bí, Thần khí dẫn tân. Thần tâm Đan Nguyên, Khiến ta thông chân. Thần tư luyện dịch, Đạo khí trường tồn.' },
];
