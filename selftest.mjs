...
assert(isFanyin({ gan: '庚', zhi: '午' }, { gan: '丙', zhi: '子' }), '庚午×丙子 (thiên khắc địa xung) = Phản Ngâm');
...
import { taiSuiGeneral, taiSuiOverview, TAISUI_60 } from './src/engine/taisui-general.js';
console.log('\n################## 17. 60 TRỊ NIÊN THÁI TUẾ 六十太岁将军 ##################');
...
assert(df.best.year === 2027, 'decade best = 2027 (khớp giao vận 戊午)');
