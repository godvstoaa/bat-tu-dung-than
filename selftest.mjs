...
// [loop 1192→1328] 滴天髓 «通論» — 20 nguyên lý (任鐵樵闡微 ctext/quanxue.cn/wikisource).
assert(Object.keys(DITIANSUI_TONGLUN).length === 20, `DITIANSUI_TONGLUN đủ 20 nguyên lý (got ${Object.keys(DITIANSUI_TONGLUN).length})`);
